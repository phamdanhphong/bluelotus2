...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
		...
		//return true;
        return TatThanhJsc.Extension.CookieExtension.CheckValidCookies("LoginSetting");
	}
	...
	{        
        ...
        string path = "pic/general";

        if (Session["CKFinderUploadPath"] != null)
            path = Session["CKFinderUploadPath"].ToString();
        
        BaseUrl = "~/"+path+"/";
            
		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = Request.PhysicalApplicationPath + "/"+path+"/";
        ...
        PluginSettings.Add("Watermark_source", Request.PhysicalApplicationPath + "/ckeditor/ckfinder/plugins/watermark/logo.png");
		...
		Thumbnails.MaxWidth = 90;
		Thumbnails.MaxHeight = 90;
		Thumbnails.Quality = 20;
		...
		// feature.
		Images.MaxWidth = 1366;
		//Images.MaxHeight = 768;
		Images.Quality = 100;
