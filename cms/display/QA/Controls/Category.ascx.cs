...
public partial class cms_display_QA_Controls_Category : System.Web.UI.UserControl
{
    ...
    #region Các thông số cần chỉnh theo từng modul (QA, QA, QA...)
    private string app = TatThanhJsc.QAModul.CodeApplications.QA;
    private string pic = TatThanhJsc.QAModul.FolderPic.QA;
    private string maxItemKey = TatThanhJsc.QAModul.SettingKey.SoQATrenTrangDanhMuc;
