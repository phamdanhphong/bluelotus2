...
<div id="ShortCutCate">
    ...
    <div class="pdControl">
        ...
        <div class="text"><div class="pt5"><%=Developer.SupportOnlineKeyword.DanhMucCha %></div></div>
        <div class="control"><asp:DropDownList ID="DdlGroupSupportOnline" runat="server" Width="252px"></asp:DropDownList></div>
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.SupportOnlineKeyword.TenDanhMuc%></div></div>
        <div class="control">
        ...
        <div class="cbh8"><!----></div>         
        <div class="text"><div class="pt5"><%=Developer.SupportOnlineKeyword.MoTa%>:</div></div>
        <div class="control">
        ...
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.SupportOnlineKeyword.Loai %>:</div></div>
        <div class="control">
        ...
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.SupportOnlineKeyword.ThuTu %>:</div></div>
        <div class="control">
        ...
        <div class="cb h8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.SupportOnlineKeyword.TrangThai %>:</div></div>
        <div class="control">
