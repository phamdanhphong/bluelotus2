...
public partial class cms_admin_Moduls_ContactUs_Item_ControlItem2 : System.Web.UI.UserControl
{
    private string app = CodeApplications.Contact;
    protected string pic = FolderPic.Contact;
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string sortCookiesName = SortKey.SortContactItems;
    private string p = "1";
    private string NumberShowItem = "2";
    ...
    protected string LinkUpdate(string iid)
    {
        ...
        {
            return LinkAdmin.GoAdminItem(CodeApplications.Contact + "2", TypePage.UpdateItem, iid, NumberShowItem, p);
        }
        else
        {
            return LinkAdmin.GoAdminItem(CodeApplications.Contact + "2", TypePage.UpdateItem, iid);
        }
    }
    ...
    private string LinkCreate()
    {
        ...
        return LinkAdmin.GoAdminCategory(CodeApplications.Contact + "2", TypePage.CreateItem, igidUpdate);
    }
    ...
    {
        string key = tbKeySearch.Text + "&name=" + tbTitleSearch.Text;
        Response.Redirect(LinkAdmin.GoAdminCategory(CodeApplications.Contact + "2", TypePage.Item, ddlCateSearch.SelectedValue,
