<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlItem.ascx.cs" Inherits="cms_admin_Moduls_ContactUs_Item_ControlItem" %>
            ...
            <ItemTemplate>
                <div id="Item-<%#Eval("IID").ToString()%>">
                    <div class="bgItem">
                        ...
                        <div class="split">|</div>                            
                        <div class="cot2" align="left">
                            <div class="pt5">- <b>Chủ đề:</b> <%#Eval("VIAUTHOR").ToString() %></div>
                            <div class="pt5">- <b>Họ tên:</b> <%#Eval("VITITLE").ToString() %></div>
                            <div class="pt5">- <b>Email:</b> <%#Eval("VIURL").ToString() %></div>
