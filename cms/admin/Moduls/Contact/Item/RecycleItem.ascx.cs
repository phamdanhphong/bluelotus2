...
public partial class cms_admin_Moduls_ContactUs_Item_RecycleItem : System.Web.UI.UserControl
{
    ...
    void GetNews(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
                                                      ...
                                                      LinkAdmin.UrlAdmin(CodeApplications.Contact, TypePage.RecycleItem,
