...
public partial class cms_admin_Moduls_ContactUs_Cate_ControlCate : System.Web.UI.UserControl
{
    ...
    {        
        return Link.LnkMnContactCateCreate();
    }
    ...
    private string LinkUpdateCate(string igid,string igparentid)
    {
        ...
        {
            return LinkAdmin.GoAdminCategory(CodeApplications.Contact, TypePage.UpdateCate, igid);    
        }
        else
        {
            return LinkAdmin.GoAdminCategory(CodeApplications.Contact, TypePage.UpdateCate, igid, igparentid);    
        }
    }
