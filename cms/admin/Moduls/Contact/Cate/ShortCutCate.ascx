<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutCate.ascx.cs" Inherits="cms_admin_Moduls_ContactUs_Cate_ShortCutCate" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Contact/Cate/ShortCutCate/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admsccate">
    ...
    <div class="pdControl">
        ...
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5">Hotline</div></div>
        <div class="control">
            <asp:TextBox ID="tbHotline" runat="server" Width="250px"></asp:TextBox>            
        </div>
        ...
        <div class="cbh8"><!----></div>         
        <div class="text"><div class="pt5">Mã nhúng bán đồ:</div></div>
        <div class="control">
            <asp:TextBox ID="txtMaps" runat="server" Width="580px" Height="50px" TextMode="MultiLine" CssClass=""></asp:TextBox>                            
        </div>
        <div class="cbh8"><!----></div>   
