<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleItem.ascx.cs" Inherits="cms_admin_Moduls_CustomerReviews_Item_RecycleItem" %>

<asp:HiddenField ID="hd_time" runat="server" />
<div id="ControlItem">
    <div class="BgTabTool">        
        <a href="javascript:DeleteRecListItems('<%=pic %>')" class="LinkDelete"><%=Developer.CustomerReviewsKeyword.Xoa%></a>                   
        <div class="right dn">            
            <div class="fl pr5">
