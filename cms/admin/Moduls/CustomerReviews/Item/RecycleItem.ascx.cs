...
public partial class cms_admin_Moduls_CustomerReviews_Item_RecycleItem : System.Web.UI.UserControl
{
    ...
    void GetCustomerReviews(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
                                                      ...
                                                      LinkAdmin.UrlAdmin(CodeApplications.CustomerReviews, TypePage.RecycleItem,
    ...
    void GetParentCate()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ddl_group_ontab.Items.Add(new ListItem(Developer.CustomerReviewsKeyword.TatCaDanhMuc, ""));
