...
public partial class cms_admin_Moduls_CustomerReviews_Item_ControlItem : System.Web.UI.UserControl
{
    protected string app = CodeApplications.CustomerReviews;
    protected string appCate = CodeApplications.CustomerReviews;
    protected string pic = FolderPic.CustomerReviews;
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string sortCookiesName = SortKey.SortCustomerReviewsItems;
    private string p = "1";
    ...
    protected string LinkUpdate(string iid)
    {
        ...
        {
            return LinkAdmin.GoAdminItem(CodeApplications.CustomerReviews, TypePage.UpdateItem, iid, NumberShowItem, p);
        }
        else
        {
            return LinkAdmin.GoAdminItem(CodeApplications.CustomerReviews, TypePage.UpdateItem, iid);
        }
    }
    ...
    protected string LinkCreate()
    {
        ...
        return LinkAdmin.GoAdminCategory(CodeApplications.CustomerReviews, TypePage.CreateItem, igidUpdate);
    }
    ...
    void GetItems(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
            ...
            LinkAdmin.UrlAdmin(CodeApplications.CustomerReviews, TypePage.Item,
    ...
    void GetParentCate()
    {
        ...
        ddlCateSearch.Items.Add(new ListItem(Developer.CustomerReviewsKeyword.TatCaDanhMuc, ""));
    ...
    {
        string key = tbKeySearch.Text + "&name=" + tbTitleSearch.Text;
        Response.Redirect(LinkAdmin.GoAdminCategory(CodeApplications.CustomerReviews, TypePage.Item, ddlCateSearch.SelectedValue,
