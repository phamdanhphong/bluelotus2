<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlsConfig.ascx.cs" Inherits="cms_admin_CustomerReviews_Controls_AdmControlsConfiguration" %>
...
<div id="ControlsConfig">    
    ...
    <div class="smalltextbox">
        <div class="fl pl20">Số <%= CustomerReviewsKeyword.CustomerReviews2 %> trên trang chủ:</div>
        <div class="fl pl10">
            <asp:TextBox ID="tbSoCustomerReviewsTrenTrangChu" runat="server"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server"
                                            ErrorMessage="Vui lòng số tự nhiên(vd: 6)" ControlToValidate="tbSoCustomerReviewsTrenTrangChu"
                                            Display="Dynamic" SetFocusOnError="True" ValidationExpression="\d*">
            </asp:RegularExpressionValidator>
        </div>
        <div class="cb h20"><!----></div>
        <div class="fl pl20">Số <%= CustomerReviewsKeyword.CustomerReviews2 %> trên trang danh mục:</div>
        <div class="fl pl10">
            <asp:TextBox ID="tbSoCustomerReviewsTrenTrangDanhMuc" runat="server"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server"
                                            ErrorMessage="Vui lòng số tự nhiên(vd: 6)" ControlToValidate="tbSoCustomerReviewsTrenTrangDanhMuc"
                                            Display="Dynamic" SetFocusOnError="True" ValidationExpression="\d*">
            </asp:RegularExpressionValidator>
        </div>
        <div class="cb h20"><!----></div>
        <div class="fl pl20">Số <%= CustomerReviewsKeyword.CustomerReviews2 %> khác trên một trang:</div>
        <div class="fl pl10">
            <asp:TextBox ID="tbSoCustomerReviewsKhacTrenMotTrang" runat="server"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server"
                                            ErrorMessage="Vui lòng số tự nhiên(vd: 6)" ControlToValidate="tbSoCustomerReviewsKhacTrenMotTrang"
                                            Display="Dynamic" SetFocusOnError="True" ValidationExpression="\d*">
            </asp:RegularExpressionValidator>
        </div>
    </div>
