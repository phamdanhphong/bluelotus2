...
public partial class cms_admin_Moduls_CustomerReviews_Cate_ShortCutCate : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.CustomerReviewsKeyword.CapNhatDanhMuc;
            btOK.Text = "Đồng ý";
        ...
        {
            LtInsertUpdate.Text = Developer.CustomerReviewsKeyword.TaoDanhMuc;
            btOK.Text = "Đồng ý";
            tbTitle.Focus();
        }
        #endregion
