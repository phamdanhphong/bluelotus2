<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutCate.ascx.cs" Inherits="cms_admin_Moduls_CustomerReviews_Cate_ShortCutCate" %>
...
<div id="ShortCutCate" class="InsertPanel InitQuikMenu">
    ...
    <div class="controlBox">
        <div class="row">
            <div class="text"><%=Developer.CustomerReviewsKeyword.DanhMucCha %></div>
            <div class="control"><asp:DropDownList ID="ddlParentCate" runat="server"></asp:DropDownList></div>
        </div>
        <div class="row">
            <div class="text"><%=Developer.CustomerReviewsKeyword.TenDanhMuc%></div>
            <div class="control">
        ...
        <div class="row">
            <div class="text"><div class="pt5"><%=Developer.CustomerReviewsKeyword.MoTa%></div></div>
            <div class="control">
        ...
        <div class="row">
            <div class="text"><%=Developer.CustomerReviewsKeyword.ThuTu %></div>
            <div class="control">
        ...
        <div class="row">
            <div class="text"><%=Developer.CustomerReviewsKeyword.TrangThai %></div>
            <div class="control">
        ...
        <div class="row">
            ...
            <div class="pt10"><CKEditor:CKEditorControl ID="tbDetail" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&amp;path=pic/CustomerReviews"></CKEditor:CKEditorControl></div>
        </div>
                
        
        <div class="subHead"><%=Developer.CustomerReviewsKeyword.ToiUuTimKiem%> </div>
        <div class="row">
            <div class="text"><%=Developer.CustomerReviewsKeyword.ToiUuTheTieuDe%> (title)</div>
            <div class="control"><asp:TextBox ID="tbSeoTitle" runat="server" CssClass="tbTitle_seo"></asp:TextBox></div>    
        </div>
        <div class="row">
            <div class="text"><%=Developer.CustomerReviewsKeyword.ToiUuDuongDan%> (url)</div>
            <div class="control"><asp:TextBox ID="tbSeoLink" runat="server" CssClass="tbLink_seo"></asp:TextBox></div>
        </div>        
        <div class="row">
            <div class="text"><%=Developer.CustomerReviewsKeyword.ToiUuTheTuKhoa%> (meta keyword)</div>
            <div class="control"><asp:TextBox ID="tbSeoKeyword" runat="server" CssClass="tbKeyword_seo"></asp:TextBox></div>    
        </div>
        <div class="row">
            <div class="text"><%=Developer.CustomerReviewsKeyword.ToiUuTheMoTa%> (meta description)</div>
