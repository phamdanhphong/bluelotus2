<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutGroupItem.ascx.cs" Inherits="cms_admin_Moduls_CustomerReviews_GroupItem_ShortCutGroupItem" %>
...
<div id="ShortCutCate" class="InsertPanel InitQuikMenu">
    ...
    <div class="controlBox">
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.CustomerReviewsKeyword.ViTri%></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.CustomerReviewsKeyword.TenNhom %></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.CustomerReviewsKeyword.MoTa%></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.CustomerReviewsKeyword.SoCustomerReviewsDuocHienThi %></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.CustomerReviewsKeyword.ThuTu %></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.CustomerReviewsKeyword.TrangThai %></div>
            </div>
            <div class="control">            
