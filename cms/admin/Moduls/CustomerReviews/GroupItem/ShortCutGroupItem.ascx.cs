...
public partial class cms_admin_Moduls_CustomerReviews_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.CustomerReviewsGroupItem;
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.CustomerReviewsKeyword.CapNhatNhomCustomerReviews;
            btOK.Text = "Đồng ý";
        ...
        {
            LtInsertUpdate.Text = Developer.CustomerReviewsKeyword.TaoNhomMoi;
            btOK.Text = "Đồng ý";
        }
        #endregion
    }
