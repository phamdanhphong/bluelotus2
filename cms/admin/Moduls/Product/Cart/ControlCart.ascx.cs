...
public partial class cms_admin_Moduls_Product_Item_ControlCart : System.Web.UI.UserControl
{
    private string app = CodeApplications.ProductCart;
    ...
    void GetList()
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
                                                      ...
                                                      LinkAdmin.UrlAdmin(CodeApplications.Product, TypePage.Cart,
                                                                   "", "",
