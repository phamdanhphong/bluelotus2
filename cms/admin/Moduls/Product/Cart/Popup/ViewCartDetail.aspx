<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewCartDetail.aspx.cs" Inherits="cms_admin_Product_ShowProductControl_ViewCart" %>
...
<body>
    ...
    <div class="ffTahoma fs12 w850 ma">
        <div>
            <%=TatThanhJsc.Extension.SettingsExtension.GetSettingKey(TatThanhJsc.ProductModul.SettingKey.NoiDungDauDonHang,TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin()) %>
        </div>
        ...
        <table cellpadding="0" cellspacing="0" class="bda" width="100%">
            <tr>
                ...
                <td class="bdr pt5 pb5 tac fwb" width="10%">Đơn giá</td>
                <td class="pt5 pb5 tac fwb" width="10%">Thành tiền</td>
            </tr>            
            <asp:Repeater ID="rptList" runat="server">
                ...
                <tr>
                    ...
                    <td class="bdr bdt pt5 pb5 tar pr5" width="10%"><%#TatThanhJsc.Extension.NumberExtension.FormatNumber(Eval(TatThanhJsc.Columns.SubitemsColumns.VsurlColumn).ToString(),true,"liên hệ","")%></td>
        ...
        <div class='cb'>
            <%=TatThanhJsc.Extension.SettingsExtension.GetSettingKey(TatThanhJsc.ProductModul.SettingKey.NoiDungCuoiDonHang,TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin()) %>
        </div>
    </div>
    </form>
</body>
