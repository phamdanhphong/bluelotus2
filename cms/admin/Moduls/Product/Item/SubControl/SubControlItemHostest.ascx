<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SubControlItemHostest.ascx.cs" Inherits="cms_admin_Moduls_Product_Item_SubControl_SubControlItemHostest" %>
<%@ Import Namespace="TatThanhJsc.AdminModul" %>
<%@ Import Namespace="TatThanhJsc.ProductModul" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">    
    <link href="~/cms/admin/Moduls/Product/Item/SubControl/SubControlItemHostest/_cs.css" rel="stylesheet" type="text/css" />   
</cc1:StyleSheetCombiner>

<asp:UpdatePanel ID="UpdatePanel1" runat="server">
<ContentTemplate>
<div id="SubProductItemHostest">    
    <div class="header">
