...
public partial class cms_admin_Moduls_Product_Item_SubControl_SubControlItemLastest : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle =ProductKeyword.Product2 + " mới cập nhật";
