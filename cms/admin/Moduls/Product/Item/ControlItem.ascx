...
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server"><link href="~/cms/admin/Moduls/Product/Item/ControlItem/_cs.css" rel="stylesheet" type="text/css" /></cc1:StyleSheetCombiner>
            ...
            <ItemTemplate>
                <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
                    <div class="bgItem">
                        ...
                        <div class="split">|</div>                        
                        <div class="fr tool pr5 tar">
                            <div class="pb3">
                                <a class="<%=ProductConfig.KeyHienThiQuanLyPhanHoiSanPham %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/PopUp/ViewComments.aspx?iid=<%#Eval("IID")%>','ImageList','1000','650','yes','yes')"><span class='iconPhanHoi'><!----></span></a>
                                <a class="<%=ProductConfig.KeyHienThiThemNhieuBaiVietChoSanPham %>" title="<%=Developer.ProductKeyword.ClickDeThemBaiViet %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/PopUp/AddNewsToItems.aspx?iid=<%#Eval("IID")%>','ImageList','1000','650','yes','yes')"><span class='iconThemBaiViet'><!----></span></a>

                                <a class="<%=ProductConfig.KeyHienThiThemNhieuVideoChoSanPham %>" title="<%=Developer.ProductKeyword.ClickDeThemVideo %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/PopUp/AddVideoToItems.aspx?iid=<%#Eval("IID")%>','ImageList','1000','650','yes','yes')"><span class='iconThemVideo'><!----></span></a>
                                <a class="<%=ProductConfig.KeyHienThiThemNhieuSubitemChoSanPham %>" title="<%=Developer.ProductKeyword.ClickDeThemSubitem %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/PopUp/AddSubitemToItems.aspx?iid=<%#Eval("IID")%>','ImageList','1000','650','yes','yes')"><span class='iconThemSubitem'><!----></span></a>                                
                                <a class="<%=TagConfig.KeyHienThiTagChoProduct%>" title="<%=Developer.ProductKeyword.ClickDeThemTag %>" href="javascript:NewWindow_('cms/admin/TempControls/PopUp/Items/AddTags.aspx?iid=<%#Eval("IID")%>&Modul=<%=app %>','ImageList','1000','650','yes','yes')"><span class='iconThemTag'><!----></span></a>
                            </div>
                           ...
                           <a class="<%#ShowUpLoadImg(Eval("IGID").ToString()) %> " title="<%=Developer.ProductKeyword.ClickDeThemHinhAnh %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/PopUp/AddPictureToItems.aspx?iid=<%#Eval("IID")%>','ImageList','1000','650','yes','yes')"><span class='iconThemAnh'><!----></span></a>
                            ...
                            <div class="dn">
                                <a title="<%=Developer.ProductKeyword.ClickDeThemVaoNhom %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/Popup/AddItemToGroups.aspx?iid=<%#Eval("IID")%>','ImageList','800','450','yes','yes')"><span class='iconThemVaoNhom'><!----></span></a>
                            </div>
...
<div id="SubItemProductSearch">
    <div class="frame">
        <div class="frame2">
            <div class="fl pr10">
                <asp:TextBox ID="tbTitleSearch" runat="server" placeholder="Tên sản phẩm"></asp:TextBox>
            </div>
            <div class="fl pr10">
                <asp:TextBox ID="tbKeySearch" runat="server" placeholder="Mã sản phẩm"></asp:TextBox>
            </div>
            <div class="fl">
