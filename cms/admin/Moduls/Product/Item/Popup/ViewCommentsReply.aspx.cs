...
public partial class cms_admin_Moduls_Product_PopUp_Items_ViewCommentsReply : System.Web.UI.Page
{
    string top = "";
    string field = "";
    string condition = "";
    ...
    string app = CodeApplications.ProductComment + "Reply";
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/Product/Item/Popup/ViewComments.aspx?iid=" + iid + "&isid=" + isid);
    }
}