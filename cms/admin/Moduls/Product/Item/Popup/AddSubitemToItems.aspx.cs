...
public partial class cms_admin_ModulMain_Video_PopUp_Items_AddSubitemToItems : System.Web.UI.Page
{
    ...
    string orderby = "";
    string condition = "";
    string app = CodeApplications.ProductSubitemOther;
...
";
    ...
    protected void btInsert_Click(object sender, EventArgs e)
    {
        ...
        tbEnddate.Text = DateTime.Now.AddDays(30).ToString();
    }
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/Product/Item/PopUp/AddSubitemToItems.aspx?iid=" + iid);
    }
    void GetList()
    {
    ...
    protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        switch (c)
        {
            ...
            case "edit":
                //OpenUpdatePanel(p);
                Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/Product/Item/PopUp/AddSubitemToItems.aspx?iid=" + iid + "&isid=" + p);
                break;
            #endregion
        }
    }
