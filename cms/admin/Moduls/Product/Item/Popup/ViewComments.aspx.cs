...
public partial class cms_admin_ModulMain_Product_PopUp_Items_ViewComments : System.Web.UI.Page
{
    string top = "";
    string fields = "";
    string orderby = "";
    string condition = "";
    string app = CodeApplications.ProductComment;
    string iid = "";
    string isid = "";
...
<div style='font:12px/18px Tahoma;color:#000;'>
    " + dt.Rows[0][ItemsColumns.VidescColumn].ToString() + @"
</div>
<div class='cbh20'><!----></div>
";
        #endregion
