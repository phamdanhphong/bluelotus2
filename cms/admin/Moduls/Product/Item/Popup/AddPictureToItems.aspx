...
<body>
    ...
    <div class="w900 ma ffTahoma fs12">        
        ...
        <div class='pb5'>
            ...
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/Product/Item/Popup/AddPictureToItems/swfupload/swfupload.js"></script>
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/Product/Item/Popup/AddPictureToItems/swfupload/handlers.js"></script>
            <script type="text/javascript">
                var swfu;
                window.onload = function () {
                    ...
                    swfu = new SWFUpload({
                        // Backend Settings            
                        upload_url: weburl + "cms/admin/Moduls/Product/Item/Popup/AddPictureToItems/upload.aspx?iid=" + iid+"&color="+color,
                        post_params: {
                        ...
                        // Button settings
                        button_image_url: weburl + "cms/admin/Moduls/Product/Item/Popup/AddPictureToItems/swfupload/btupload.png",
                        ...
                        // Flash Settings
                        flash_url: weburl + "cms/admin/Moduls/Product/Item/Popup/AddPictureToItems/swfupload/swfupload.swf", // Relative to this file
            ...
            <asp:Panel ID="pnMauSanPham1" runat="server">            
                <div>
        ...
        <asp:Panel ID="pnMauSanPham" runat="server">            
        <div>
            <div>Chọn màu sản phẩm</div>
            <div class='cb h5'><!----></div>
            <div id="ListColor">
