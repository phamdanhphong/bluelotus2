...
public partial class cms_admin_ModulMain_Video_PopUp_Items_AddVideoToItems : System.Web.UI.Page
{
    string top = "";
    string fields = "";
    string orderby = "";
    string condition = "";
    string app = CodeApplications.ProductVideoOther;
...
";
    ...
    {
        ltrInsertUpdate.Text = "Thêm mới video";
        update = false;
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/Product/Item/PopUp/AddVideoToItems.aspx?iid=" + iid);
    }
    void GetList()
    {
    ...
    protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        switch (c)
        {
            ...
            case "edit":
                //OpenUpdatePanel(p);
                Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/Product/Item/PopUp/AddVideoToItems.aspx?iid=" + iid + "&isid=" + p);
                break;
            #endregion
        }
    }
    ...
    {
        ltrInsertUpdate.Text = "Cập nhật video";
        update = true;
        ...
        {            
            ...
            tbYoutubecode.Text = dt.Rows[0][SubitemsColumns.VsemailColumn].ToString();
        }
    }
