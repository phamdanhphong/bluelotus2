...
<head runat="server">
    <title><%=ProductKeywordSub.ThemLoaiChoSanPham %></title>        
...
<body>
    ...
    <div class="w900 ma ffTahoma fs12">        
        ...
        <div class='fwb pb10 pt10'>
            <%=ProductKeywordSub.DanhSachLoai %>:                 
        </div>
        <div class='pb5'>
            <span class='ImageCreateRecord'><!----></span>
            <asp:LinkButton ID="btInsert" runat="server" ToolTip="Click để thêm mới" CssClass="lbtInsert" onclick="btInsert_Click">Thêm mới</asp:LinkButton>            
                ...
                <ItemTemplate>
                    <div class='pt5 pb5 bdbs'>
                        <div class='fl w200 pl5'>                            
                            <%#ImagesExtension.GetImage(FolderPic.Product, Eval(TatThanhJsc.Columns.SubitemsColumns.VsimageColumn).ToString(), "", "hotelImage", false, false, "")%>&nbsp;
                        </div>
        ...
        <div class="display<%=ProductConfigSub.KeyHienThiMota %>">
        ...
        <div class="display<%=ProductConfigSub.KeyHienThiGiaBan %>">
            <div class='fl w120'><%=ProductKeywordSub.GiaBan %></div>
            <div class='fl'>
                <div>
                ...
                <div>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                                ErrorMessage="Vui lòng nhập kiểu số (vd:12 hoặc 12.5)" ControlToValidate="tbPrice" Display="Dynamic" 
                                SetFocusOnError="True" ValidationExpression="(\d)*(\.)?(\d)*"></asp:RegularExpressionValidator>
                </div>
            </div>
            <div class='cb h5'><!----></div>
        </div>
        <div class="display<%=ProductConfigSub.KeyHienThiGiaNiemYet %>">            
            <div>
                <div class='fl w120'><%=ProductKeywordSub.GiaNiemYet %></div>
                <div class='fl'>
                   <div>
                    ...
                    <div>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
                                    ErrorMessage="Vui lòng nhập kiểu số (vd:12 hoặc 12.5)" ControlToValidate="tbPriceOld" Display="Dynamic" 
                                    SetFocusOnError="True" ValidationExpression="(\d)*(\.)?(\d)*"></asp:RegularExpressionValidator>
                    </div>
                </div>
                <div class='cb h5'><!----></div>
            ...
            <script type="text/javascript">
                ...
                function DinhDangGia(number) {
                    if (isNaN(number)) return "<span style='font:normal 12px Arial;color:red'>Số nhập sai định dạng!</span>";
        ...
        <div class="display<%=ProductConfigSub.KeyHienThiNgayTao %>">
            <div class='fl w120'><%=ProductKeywordSub.NgayTao %></div>
            <div class='fl'>
                <div>
                    <asp:TextBox ID="tbCreateDate" runat="server" Width="250px"></asp:TextBox>                    
                </div>                
            </div>
            <div class='cb h5'><!----></div>
        </div>
                     
        <div class="display<%=ProductConfigSub.KeyHienThiNgayHetHan %>">
            <div class='fl w120'><%=ProductKeywordSub.NgayHetHan %></div>
            <div class='fl'>
                <div>
                    <asp:TextBox ID="tbEnddate" runat="server" Width="250px"></asp:TextBox>                    
                </div>                
            </div>
            <div class='cb h5'><!----></div>
        </div>            
                      
        <div class="display<%=ProductConfigSub.KeyHienThiThamSo1 %>">
            <div class='fl w120'><%=ProductKeywordSub.ThamSo1 %></div>
            <div class='fl'>
                <div>
                    <asp:TextBox ID="tbParam1" runat="server" Width="250px"></asp:TextBox>                    
                </div>                
            </div>
            <div class='cb h5'><!----></div>
        </div>

        <div class="display<%=ProductConfigSub.KeyHienThiThamSo2 %>">
            <div class='fl w120'><%=ProductKeywordSub.ThamSo2 %></div>
            <div class='fl'>
                <div>
                    <asp:TextBox ID="tbParam2" runat="server" Width="250px"></asp:TextBox>                    
                </div>                
            </div>
            <div class='cb h5'><!----></div>
        </div>
            
        <div class="display<%=ProductConfigSub.KeyHienThiThamSo3 %>">
            <div class='fl w120'><%=ProductKeywordSub.ThamSo3 %></div>
            <div class='fl'>
                <div>
                    <asp:TextBox ID="tbParam3" runat="server" Width="250px"></asp:TextBox>                    
                </div>                
            </div>
            <div class='cb h5'><!----></div>
        </div>                              

        <div class="display<%=ProductConfigSub.KeyHienThiAnhDaiDien %>">   
        ...
        <div class="display<%=ProductConfigSub.KeyHienThiThuTu %>">
