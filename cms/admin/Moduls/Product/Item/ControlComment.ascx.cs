...
public partial class cms_admin_Moduls_Product_Item_ControlComment : System.Web.UI.UserControl
{
    ...
    void GetComments()
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
                                                      ...
                                                      LinkAdmin.UrlAdmin(CodeApplications.Product, TypePage.Comment,
                                                                   "", "",
