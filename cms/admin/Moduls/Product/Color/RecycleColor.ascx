<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleColor.ascx.cs" Inherits="cms_admin_Moduls_Product_Color_RecycleColor" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Product/Color/RecycleColor/_cs.css" rel="stylesheet" type="text/css" />
