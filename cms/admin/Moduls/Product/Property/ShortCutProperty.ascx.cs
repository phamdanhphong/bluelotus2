...
public partial class cms_admin_Moduls_Product_Property_ShortCutProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.ProductProperty;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Product, TypePage.Property, DdlGroupProduct.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        {
            LtInsertUpdate.Text = Developer.ProductKeyword.TaoThuocTinhMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
