...
public partial class cms_admin_Moduls_Product_Filter_ShortCutFilter : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.ProductFilterProperties;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Product, TypePage.Filter, DdlGroupProduct.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.ProductKeyword.CapNhatThuocTinh;
        ...
        {
            LtInsertUpdate.Text = Developer.ProductKeyword.TaoThuocTinhLocMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
