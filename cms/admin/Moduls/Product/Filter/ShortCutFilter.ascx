<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutFilter.ascx.cs" Inherits="cms_admin_Moduls_Product_Filter_ShortCutFilter" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Product/Filter/ShortCutFilter/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admsccate">
    ...
    <div class="pdControl">
        ...
        <div class="text"><div class="pt5"><%=Developer.ProductKeyword.LoaiThuocTinh %></div></div>
        ...
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.ProductKeyword.TenThuocTinh%></div></div>
        <div class="control">
        ...
        <div class="cbh8"><!----></div>         
        <div class="text"><%=Developer.ProductKeyword.AnhDaiDien%>:</div>
        ...
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.ProductKeyword.ThuocTinhLocCon%>:</div></div>
        <div class="control">
