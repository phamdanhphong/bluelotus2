<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutCate.ascx.cs" Inherits="cms_admin_Moduls_Product_Cate_ShortCutCate" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<%@ Register src="../../../../api/Product/Cate/Index.ascx" tagname="Index" tagprefix="uc1" %>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<asp:HiddenField ID="hdOldContent" runat="server" Value=""/>

<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Product/Cate/ShortCutCate/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admsccate">
    ...
    <div class="pdControl">
        ...
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.ProductKeyword.TenDanhMuc%></div></div>
        <div class="control">
        ...
        <div class="khungThuocTinh psr">
         ...
         <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5">Loại danh mục :</div></div>
        <div class="control">
           <asp:DropDownList ID="dlTypeGroup" runat="server" Width="252px">
                <asp:ListItem Value="1" Text="KHÔNG GIAN TIỆC CƯỚI"></asp:ListItem>
                <asp:ListItem Value="2" Text="DỊCH VỤ CƯỚI KÈM THEO"></asp:ListItem>
                <asp:ListItem Value="3" Text="ALBUM ẢNH CƯỚI TẠI BLUE LOTUS"></asp:ListItem>
                <asp:ListItem Value="4" Text="GÓI ALBUM ẢNH CƯỚI TẠI BLUE LOTUS"></asp:ListItem>
           </asp:DropDownList>            
        </div>
        <div class="cbh8"><!----></div>
        ...
        <div class="dn">
         ...
         <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5">Tiêu đề quảng cáo :</div></div>
        <div class="control">
            <asp:TextBox ID="txtTitleQC" runat="server" Width="580px" ></asp:TextBox>                   
        </div>
        <div class="cbh8"><!----></div>
         <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5">Giá liên hệ quảng cáo :</div></div>
        <div class="control">
            <asp:TextBox ID="txtGiaLienHe" runat="server" Width="580px" ></asp:TextBox>                   
        </div>
         <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5">Liên hệ :</div></div>
        <div class="control">
            <asp:TextBox ID="txtLienHeNgay" runat="server" Width="580px" ></asp:TextBox>                   
        </div>
        <div class="cbh8"><!----></div>
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5">Link quảng cáo:</div></div>
        <div class="control">
            <asp:TextBox ID="txtLinkQC" runat="server" Width="580px" ></asp:TextBox>                   
        </div>
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5">Quảng cáo sẽ mở ra:</div></div>
        <div class="control">
        ...
        <div class="control">
         ...
         <div class="cb h8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.ProductKeyword.HienThiTaiTrangChu %>:</div></div>
        <div class="control">
            <div><asp:CheckBox ID="chk_DisplayHome" runat="server" CssClass="cccc fs11" Text="(tích chọn để hiển thị)" Checked="true"/></div>
        </div>
        <div class="cb h8"><!----></div>
