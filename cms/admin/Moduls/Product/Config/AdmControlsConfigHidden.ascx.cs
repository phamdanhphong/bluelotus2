...
public partial class cms_admin_Product_Controls_AdmControlsConfigurationHidden : System.Web.UI.UserControl
{
    string top = "";
    string fields = "";
    string orderby = "";
    string condition = "";
    string app = CodeApplications.ProductOthersFields;
    ...
    void DeleteProductFields(string igid)
    {
