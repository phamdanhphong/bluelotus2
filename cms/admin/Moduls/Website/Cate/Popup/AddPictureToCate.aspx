<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPictureToCate.aspx.cs" Inherits="cms_admin_ModulMain_Website_PopUp_Items_AddPictureToCate" ValidateRequest="false"%>
...
<head runat="server">
    <title>Thêm hình ảnh cho hình ảnh</title>        
    ...
    <link href="AddPictureToCate/_cs.css" rel="stylesheet" type="text/css" />
    <link href="../../../../cs/Common.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
    <div id="AddPictureToCate">    
    <asp:HiddenField ID="currentIid" runat="server" />
    <div class="w900 ma ffTahoma fs12">        
        ...
        <div class='pb5'>
            ...
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/Website/Cate/Popup/AddPictureToCate/swfupload/swfupload.js"></script>
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/Website/Cate/Popup/AddPictureToCate/swfupload/handlers.js"></script>
            <script type="text/javascript">
                var swfu;
                window.onload = function () {
                    ...
                    swfu = new SWFUpload({
                        // Backend Settings            
                        upload_url: weburl + "cms/admin/Moduls/Website/Cate/Popup/AddPictureToCate/upload.aspx?igid=" + igid,
                        post_params: {
                        ...
                        // Button settings
                        button_image_url: weburl + "cms/admin/Moduls/Website/Cate/Popup/AddPictureToCate/swfupload/btupload.png",
                        ...
                        // Flash Settings
                        flash_url: weburl + "cms/admin/Moduls/Website/Cate/Popup/AddPictureToCate/swfupload/swfupload.swf", // Relative to this file
                ...
                <ItemTemplate>
                    <div class='pt5 pb5 bdbs'>
                        <div class='fl w200 pl5'>
                            <%#ImagesExtension.GetImage(FolderPic.Website, Eval(TatThanhJsc.Columns.ItemsColumns.ViimageColumn).ToString(), "", "hotelImage", false, false, "")%>&nbsp;
                        </div>
                        <div class='fl w200 pl5 bdls bdrs'>                            
                            <asp:TextBox ID="tbTitle" runat="server" Text='<%#Eval(TatThanhJsc.Columns.ItemsColumns.VititleColumn).ToString()%>' ToolTip='<%#Eval("IID").ToString()%>'  CssClass="TextInBox" TextMode="MultiLine" style="width:180px;height:60px;font-size:12px;resize:none" AutoPostBack="true" OnTextChanged="UpdateTitle"></asp:TextBox>&nbsp;
                        </div>                                             
                        <div class='fl w100 bdrs tac'>
                            <asp:TextBox ID="tbOrder" runat="server" Text='<%#Eval(TatThanhJsc.Columns.ItemsColumns.IiorderColumn).ToString()%>' ToolTip='<%#Eval("IID").ToString()%>'  CssClass="TextInBox" style="width:70px;font-size:12px" AutoPostBack="true" OnTextChanged="UpdateOrder"></asp:TextBox>
                        </div>
                        <div class='fl w100 bdrs tac'>                            
                            <asp:LinkButton ID="LinkButton4" runat="server" CommandName="EditEnable" CommandArgument='<%#Eval("iid").ToString() %>' ToolTip="Click vào để thay đổi trạng thái">                                
                                <div class="EnableIcon<%#Eval(TatThanhJsc.Columns.ItemsColumns.IienableColumn).ToString()%>"><!----></div>
                            </asp:LinkButton>
                        </div>
                        <div class='fr pr5'>                                                        
                            <asp:LinkButton ToolTip="Click để thay đổi thông tin" ID="lnk_update" runat="server" CommandName="edit" CommandArgument='<%#Eval("iid").ToString() %>'><span class='iconEdit'><!----></span></asp:LinkButton>                                                                          
                            <asp:LinkButton ToolTip="Click để xóa mục đang chọn" ID="lnk_delete" runat="server" CommandName="delete" CommandArgument='<%#Eval("iid").ToString() %>' OnClientClick="Thong bao"><span class='iconDelete'><!----></span></asp:LinkButton>                            
                        </div>
                        <div class='cb'><!----></div>
                    </div>
                </ItemTemplate>
