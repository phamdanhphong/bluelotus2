...
public partial class cms_admin_Moduls_Website_Cate_ShortCutCate : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.Website;
    private string pic = FolderPic.Website;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Website, TypePage.Cate, DdlGroupWebsite.SelectedValue);
    }
    ...
    void ResetControls()
    {
        ...
        ltimg.Text = "";
        hd_img.Value = "";
        hd_parent = DdlGroupWebsite.SelectedValue;
        txtDesc.Text = "";
