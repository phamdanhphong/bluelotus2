<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutCate.ascx.cs" Inherits="cms_admin_Moduls_Website_Cate_ShortCutCate" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Website/Cate/ShortCutCate/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admsccate">
    ...
    <div class="pdControl">
        ...
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.DanhMucCha %></div></div>
        <div class="control"><asp:DropDownList ID="DdlGroupWebsite" runat="server" Width="252px"></asp:DropDownList></div>
        
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.TenMien %></div></div>
        <div class="control">
            <asp:TextBox ID="tbTenMien" runat="server" Width="250px"></asp:TextBox>            
        </div>

        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.TieuDeNhom %></div></div>
        <div class="control">
        ...
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.DiaChi %></div></div>
        <div class="control">
            <asp:TextBox ID="tbDiaChi" runat="server" Width="580px" TextMode="MultiLine"></asp:TextBox>            
        </div>
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.DienThoai %></div></div>
        <div class="control">
            <asp:TextBox ID="tbDienThoai" runat="server" Width="250px"></asp:TextBox>            
        </div>
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.Fax %></div></div>
        <div class="control">
            <asp:TextBox ID="tbFax" runat="server" Width="250px"></asp:TextBox>            
        </div>
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.Email %></div></div>
        <div class="control">
            <asp:TextBox ID="tbEmail" runat="server" Width="250px"></asp:TextBox>            
        </div>

        <div class="cbh8"><!----></div>         
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.MoTa%>:</div></div>
        <div class="control">
            <asp:TextBox ID="txtDesc" runat="server" Width="580px" Height="50px" TextMode="MultiLine"></asp:TextBox>                            
        </div>
        <div class="cbh8"><!----></div>         
        <div class="text"><%=Developer.WebsiteKeyword.AnhDaiDien%>:</div>
        ...
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.NgayKhoiTao %></div></div>
        <div class="control">
            <asp:TextBox ID="tbCreateDate" runat="server" Width="250px"></asp:TextBox> (MM/dd/yyyy)    
        </div>
        
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.NgayHetHan %></div></div>
        <div class="control">
            <asp:TextBox ID="tbEndDate" runat="server" Width="250px"></asp:TextBox> (MM/dd/yyyy)    
        </div>

        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.ThuTu %>:</div></div>
        <div class="control">
        ...
        <div class="cb h8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.TrangThai %>:</div></div>
        <div class="control">
        ...
        <div class="cbh20"><!----></div>
        <div class="TextSeoLink"><%=Developer.WebsiteKeyword.ToiUuTimKiem%> </div>
        <div>
            <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.ToiUuDuongDan%>: </div></div>
            <div class="control"><asp:TextBox ID="textLinkRewrite" runat="server" Width="450px" CssClass="tbLink_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.ToiUuTheTieuDe%>: </div></div>
            <div class="control"><asp:TextBox ID="textTagTitle" runat="server" Width="450px" CssClass="tbTitle_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.ToiUuTheTuKhoa%>: </div></div>
            <div class="control"><asp:TextBox ID="textTagKeyword" runat="server" Width="450px" CssClass="tbKeyword_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.WebsiteKeyword.ToiUuTheMoTa%>: </div></div>
            <div class="control"><asp:TextBox ID="textTagDescription" runat="server" Width="580px" Height="50px" TextMode="MultiLine" CssClass="tbKeyword_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
        </div>
