<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutService.ascx.cs" Inherits="cms_admin_Moduls_Tour_Service_ShortCutService" %>
...
<div id="ShortCutCate" class="InsertPanel InitQuikMenu">
    ...
    <div class="controlBox">
        ...
        <div class="row">
            <div class="text"><%=Developer.TourKeyword.TenDichVu%></div>
            <div class="control">
