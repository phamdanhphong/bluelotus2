...
public partial class cms_admin_Moduls_Tour_Service_ShortCutService : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    protected string app = CodeApplications.TourService;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (suc.Equals(TypePage.CreateService))
            insert = true;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Tour, TypePage.Service, ddlParentCate.SelectedValue);
    }
