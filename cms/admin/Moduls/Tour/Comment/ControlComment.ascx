<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlComment.ascx.cs" Inherits="cms_admin_Moduls_Tour_Comment_ControlComment" %>
            ...
            <ItemTemplate>
                <div class="Item" id="Item-<%#Eval("ISID").ToString()%>">
                    <div class="bgItem">
                        ...
                        <div class="split">|</div>                            
                        <div class="cot2" align="left">
                            <b>Bài viết: <%#GetItemNameById(Eval("IID").ToString()) %></b><br/>
                            <b>Họ tên</b>: <%#Eval("VSTITLE").ToString() %><br/>
                            <b>Email</b>: <%#Eval("VSEMAIL").ToString() %><br/>
                            <b>Nội dung</b>:<br/>
                            <div class="cmtContent"><%#Eval("VSCONTENT").ToString() %></div>
                        </div>                            
                        <div class="split">|</div>                            
