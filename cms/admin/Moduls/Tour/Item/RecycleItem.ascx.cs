...
public partial class cms_admin_Moduls_Tour_Item_RecycleItem : System.Web.UI.UserControl
{
    ...
    void GetTour(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
                                                      ...
                                                      LinkAdmin.UrlAdmin(CodeApplications.Tour, TypePage.RecycleItem,
    ...
    void GetParentCate()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ddl_group_ontab.Items.Add(new ListItem(Developer.TourKeyword.TatCaDanhMuc, ""));
