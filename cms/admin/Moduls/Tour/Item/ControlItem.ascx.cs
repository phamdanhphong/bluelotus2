...
public partial class cms_admin_Moduls_Tour_Item_ControlItem : System.Web.UI.UserControl
{
    protected string app = CodeApplications.Tour;
    ...
    protected string LinkUpdate(string iid)
    {
        ...
        {
            return LinkAdmin.GoAdminItem(CodeApplications.Tour, TypePage.UpdateItem, iid, NumberShowItem, p);
        }
        else
        {
            return LinkAdmin.GoAdminItem(CodeApplications.Tour, TypePage.UpdateItem, iid);
        }
    }
    ...
    protected string LinkCreate()
    {
        ...
        return LinkAdmin.GoAdminCategory(CodeApplications.Tour, TypePage.CreateItem, igidUpdate);
    }
    ...
    void GetItems(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
            ...
            LinkAdmin.UrlAdmin(CodeApplications.Tour, TypePage.Item,
    ...
    void GetParentCate()
    {
        ...
        ddlCateSearch.Items.Add(new ListItem(Developer.TourKeyword.TatCaDanhMuc, ""));
    ...
    {
        string key = tbKeySearch.Text + "&name=" + tbTitleSearch.Text;
        Response.Redirect(LinkAdmin.GoAdminCategory(CodeApplications.Tour, TypePage.Item, ddlCateSearch.SelectedValue,
