<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutGroupItem.ascx.cs" Inherits="cms_admin_Moduls_Tour_GroupItem_ShortCutGroupItem" %>
...
<div id="ShortCutCate" class="InsertPanel InitQuikMenu">
    ...
    <div class="controlBox">
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.TourKeyword.ViTri%></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.TourKeyword.TenNhom %></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.TourKeyword.MoTa%></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.TourKeyword.SoTourDuocHienThi %></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.TourKeyword.ThuTu %></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.TourKeyword.TrangThai %></div>
            </div>
            <div class="control">            
