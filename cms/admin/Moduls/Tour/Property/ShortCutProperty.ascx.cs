...
public partial class cms_admin_Moduls_Tour_Property_ShortCutProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    protected string app = CodeApplications.TourProperty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        flAnhDaiDien.App = CodeApplications.Tour;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Tour, TypePage.Property, ddlParentCate.SelectedValue);
    }
