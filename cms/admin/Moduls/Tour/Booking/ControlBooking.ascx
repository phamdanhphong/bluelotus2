<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlBooking.ascx.cs" Inherits="cms_admin_Moduls_Tour_Booking_ControlBooking" %>
...
<div id="ControlItem">
    <div id="ControlComment">
        <div class="BgTabTool">
        <a href="javascript:DeleteListSubItems()" class="LinkDelete"><%=Developer.TourKeyword.Xoa%></a>                   
        <div class="right">            
                ...
                <div class="Item" id="Item-<%#Eval("ISID").ToString()%>">
                    <div class="bgItem">
                        ...
                        <div class="cot2" align="left" style="line-height:18px">
                            <b>Tour: <%#GetItemNameById(Eval("IID").ToString()) %></b><br/>
                            ...
                            <b>Thông tin tour</b>
                            <ul>
                                <%#LayThongTinTour(Eval("vsParams").ToString()) %>
                            </ul>
                        </div>                            
                        <div class="split">|</div>                            
