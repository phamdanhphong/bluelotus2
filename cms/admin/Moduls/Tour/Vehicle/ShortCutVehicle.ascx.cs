...
public partial class cms_admin_Moduls_Tour_Vehicle_ShortCutVehicle : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    protected string app = CodeApplications.TourVehicle;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (suc.Equals(TypePage.CreateVehicle))
            insert = true;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Tour, TypePage.Vehicle, ddlParentCate.SelectedValue);
    }
