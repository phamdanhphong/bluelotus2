<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutVehicle.ascx.cs" Inherits="cms_admin_Moduls_Tour_Vehicle_ShortCutVehicle" %>
...
<div id="ShortCutCate" class="InsertPanel InitQuikMenu">
    ...
    <div class="controlBox">
        ...
        <div class="row">
            <div class="text"><%=Developer.TourKeyword.TenPhuongTien%></div>
            <div class="control">
