<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlCart.ascx.cs" Inherits="cms_admin_Moduls_Deal_Item_ControlCart" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server"><link href="~/cms/admin/Moduls/Deal/Cart/ControlCart/_cs.css" rel="stylesheet" type="text/css" /></cc1:StyleSheetCombiner>
...
<div id="ControlCart">
    ...
    <div class="BgTabTitle" align="center">
        ...
        <div class="cot2" align="left">        
            <%=Developer.DealKeyword.ThongTinDonHang %>
        </div>
        <div class="split">|</div>                    
        <div class="cot3">
                ...
                <div id="Item-<%#Eval("IID").ToString()%>">
                    <div class="bgItem">
                        ...
                        <div class="fr tool pr5">                            
                            <a title="Click để xem chi tiết phản hồi này" href="javascript:void(0)" onclick="NewWindow_('cms/admin/Moduls/Deal/Cart/Popup/ViewCartDetail.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconDonHang'><!----></span></a>
