<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewCartDetail.aspx.cs" Inherits="cms_admin_Deal_ShowDealControl_ViewCart" %>
...
<body>
    ...
    <div class="ffTahoma fs12 w850 ma">
        <div>
            <%=TatThanhJsc.Extension.SettingsExtension.GetSettingKey(TatThanhJsc.DealModul.SettingKey.NoiDungDauDonHangDeal,TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin()) %>
        </div>
        ...
        <div class='cb'>
            <%=TatThanhJsc.Extension.SettingsExtension.GetSettingKey(TatThanhJsc.DealModul.SettingKey.NoiDungCuoiDonHangDeal,TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin()) %>
        </div>
    </div>
    </form>
</body>
