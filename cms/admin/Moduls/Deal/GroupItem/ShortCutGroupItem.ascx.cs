...
public partial class cms_admin_Moduls_Deal_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.DealKeyword.CapNhatNhomDeal;
        ...
        {
            LtInsertUpdate.Text = Developer.DealKeyword.TaoNhomMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
