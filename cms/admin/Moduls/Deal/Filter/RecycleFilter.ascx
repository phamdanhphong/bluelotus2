<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleFilter.ascx.cs" Inherits="cms_admin_Moduls_Deal_Filter_RecycleFilter" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Deal/Filter/RecycleFilter/_cs.css" rel="stylesheet" type="text/css" />
