<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutFilter.ascx.cs" Inherits="cms_admin_Moduls_Deal_Filter_ShortCutFilter" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Deal/Filter/ShortCutFilter/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admsccate">
    ...
    <div class="pdControl">
        ...
        <div class="text"><div class="pt5"><%=Developer.DealKeyword.LoaiThuocTinh %></div></div>
        <div class="control"><asp:DropDownList ID="ddlFilterType" runat="server" Width="252px"></asp:DropDownList></div>
        <div class="cbh8"><!----></div>            

        <div class="text"><div class="pt5"><%=Developer.DealKeyword.DanhMucCha %></div></div>
        <div class="control"><asp:DropDownList ID="DdlGroupDeal" runat="server" Width="252px"></asp:DropDownList></div>
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.DealKeyword.TenThuocTinh%></div></div>
        <div class="control">
        ...
        <div class="cbh8"><!----></div>         
        <div class="text"><div class="pt5"><%=Developer.DealKeyword.MoTa%>:</div></div>
        <div class="control">
            <asp:TextBox ID="txtDesc" runat="server" Width="580px" Height="50px" TextMode="MultiLine" CssClass="tbDesc"></asp:TextBox>                            
        </div>
        <div class="cbh8"><!----></div>         
        <div class="text"><%=Developer.DealKeyword.AnhDaiDien%>:</div>
        ...
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.DealKeyword.ThuocTinhLocCon%>:</div></div>
        <div class="control">
            <asp:DropDownList ID="ddlSubFilterMode" runat="server">
                <asp:ListItem Value="0" Text="Chọn 1 thuộc tính/deal"></asp:ListItem>
                <asp:ListItem Value="1" Text="Chọn nhiều thuộc tính/deal"></asp:ListItem>
            </asp:DropDownList>
        </div>
        
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.DealKeyword.ThuTu %>:</div></div>
        <div class="control">
        ...
        <div class="cb h8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.DealKeyword.TrangThai %>:</div></div>
        <div class="control">
        ...
        <div class="cbh20"><!----></div>
        <div class="TextSeoLink"><%=Developer.DealKeyword.ToiUuTimKiem%> </div>
        <div>
            <div class="text"><div class="pt5"><%=Developer.DealKeyword.ToiUuDuongDan%>: </div></div>
            <div class="control"><asp:TextBox ID="textLinkRewrite" runat="server" Width="450px" CssClass="tbLink_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.DealKeyword.ToiUuTheTieuDe%>: </div></div>
            <div class="control"><asp:TextBox ID="textTagTitle" runat="server" Width="450px" CssClass="tbTitle_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.DealKeyword.ToiUuTheTuKhoa%>: </div></div>
            <div class="control"><asp:TextBox ID="textTagKeyword" runat="server" Width="450px" CssClass="tbKeyword_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.DealKeyword.ToiUuTheMoTa%>: </div></div>
