...
public partial class cms_admin_Moduls_Deal_Color_ShortCutColor : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.DealColors;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Deal, TypePage.Color, DdlGroupDeal.SelectedValue);
    }
