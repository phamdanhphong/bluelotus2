<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutColor.ascx.cs" Inherits="cms_admin_Moduls_Deal_Color_ShortCutColor" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Deal/Color/ShortCutColor/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admsccate">
    ...
    <div class="pdControl">
        ...
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.DealKeyword.TenMau%></div></div>
        <div class="control">
        ...
        <div class="cbh8"><!----></div>         
        <div class="text"><div class="pt5"><%=Developer.DealKeyword.ChonMaMau%>:</div></div>
        <div class="control">
