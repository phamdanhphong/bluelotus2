...
public partial class cms_admin_Moduls_Deal_Item_RecycleItem : System.Web.UI.UserControl
{
    ...
    void GetNews(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
                                                      ...
                                                      LinkAdmin.UrlAdmin(CodeApplications.Deal, TypePage.RecycleItem,
    ...
    void GetGroupsInDdl()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ddl_group_ontab.Items.Add(new ListItem(Developer.DealKeyword.TatCaDanhMuc, ""));
