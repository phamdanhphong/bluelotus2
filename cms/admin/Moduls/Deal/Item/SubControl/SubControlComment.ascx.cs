...
public partial class cms_admin_Moduls_Deal_Item_SubControl_SubControlComment : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle = "Phản hồi "+DealKeyword.Deal2+" mới";
    private string app = CodeApplications.DealComment;
