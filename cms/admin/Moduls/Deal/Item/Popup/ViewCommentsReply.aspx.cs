...
public partial class cms_admin_Moduls_Deal_PopUp_Items_ViewCommentsReply : System.Web.UI.Page
{
    string top = "";
    string field = "";
    string condition = "";
    ...
    string app = CodeApplications.DealComment + "Reply";
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/Deal/Item/Popup/ViewComments.aspx?iid=" + iid + "&isid=" + isid);
    }
}