...
public partial class cms_admin_ModulMain_Hotel_PopUp_Items_AddPictureToItems : System.Web.UI.Page
{
    ...
    void GetListColor()
    {
        if (HienThiMau())
        {
            pnMauDeal.Visible = true;
            pnMauDeal1.Visible = true;
            fields = DataExtension.GetListColumns(GroupsColumns.VgnameColumn, GroupsColumns.IgidColumn, GroupsColumns.VgparamsColumn);
            condition = GroupsTSql.GetGroupsCondition(language, CodeApplications.DealColors, "0", " IGENABLE <> '2' ");
        ...
        {
            pnMauDeal.Visible = false;
            pnMauDeal1.Visible = false;
        }
    }
...
";
    ...
    protected void btCancel_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/Deal/Item/PopUp/AddPictureToItems.aspx?iid=" + iid);
    }
    void GetList()
    {
    ...
    protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        switch (c)
        {
            ...
            case "edit":
                //OpenUpdatePanel(p);
                Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/Deal/Item/PopUp/AddPictureToItems.aspx?iid=" + iid + "&isid=" + p);
                break;
            #endregion
        }
    }
