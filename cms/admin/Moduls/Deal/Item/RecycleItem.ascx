<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleItem.ascx.cs" Inherits="cms_admin_Moduls_Deal_Item_RecycleItem" %>
...
<div id="admitem">
    <div class="BgTabTool">        
        <a href="javascript:DeleteRecListItems('<%=pic %>')" class="LinkDelete"><%=Developer.DealKeyword.Xoa%></a>                   
        <div class="right">            
            <div class="fl pr5">
