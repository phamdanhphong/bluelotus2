...
public partial class cms_admin_Moduls_Deal_Property_ShortCutProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.DealProperty;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Deal, TypePage.Property, DdlGroupDeal.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        {
            LtInsertUpdate.Text = Developer.DealKeyword.TaoThuocTinhMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
