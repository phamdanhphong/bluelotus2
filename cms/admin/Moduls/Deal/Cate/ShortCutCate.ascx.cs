...
public partial class cms_admin_Moduls_Deal_Cate_ShortCutCate : System.Web.UI.UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Deal, TypePage.Cate, DdlGroupDeal.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.DealKeyword.CapNhatDanhMuc;
        ...
        {
            LtInsertUpdate.Text = Developer.DealKeyword.TaoDanhMuc;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
