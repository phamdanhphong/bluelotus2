...
public partial class cms_admin_ModulMain_Deal_PopUp_Category_PopupAddFilterPropertiesToCategory : System.Web.UI.Page
{
    string igid = "";
    string top = "";
    string fields = "";
    string orderBy = "";
    string condition = "";
    string app = CodeApplications.DealFilterProperties;
