...
public partial class cms_admin_Ajax_Groups_Advertising_UpdateOrderGroup_Advertising : System.Web.UI.Page
{
    cms_admin_Moduls_Advertising_Cate_ControlCate cateControls=new cms_admin_Moduls_Advertising_Cate_ControlCate();

    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string Modul = TatThanhJsc.AdvertisingModul.CodeApplications.Advertising;
