...
public partial class cms_admin_Ajax_Groups_Email_UpdateOrderGroup_UpdateOrderGroup : System.Web.UI.Page
{
    cms_admin_Moduls_Email_Cate_ControlCate cateControls=new cms_admin_Moduls_Email_Cate_ControlCate();
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string Modul = CodeApplications.MemberNoticeBQT;
