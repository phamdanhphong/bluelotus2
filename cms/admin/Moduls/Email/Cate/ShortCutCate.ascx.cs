...
public partial class cms_admin_Moduls_Email_Cate_ShortCutCate : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (hd_insert_update.Equals("cglr"))
            insert = true;
    ...
    {
        return "admin.aspx?uc=" + TatThanhJsc.MemberModul.CodeApplications.MemberNewsletter + "&suc=glr";
    }
    ...
    protected void btn_insert_update_Click(object sender, EventArgs e)
    {
        ...
        string content = StringExtension.GhepChuoi("", tbDiaChi.Text, tbDienThoai.Text, tbFax.Text, tbEmail.Text, tbKinhDo.Text, tbViDo.Text,tbWebsite.Text);        
