<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutCate.ascx.cs" Inherits="cms_admin_Moduls_Blog_Cate_ShortCutCate" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Blog/Cate/ShortCutCate/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="ShortCutCate">
    ...
    <div class="pdControl">
        ...
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.BlogKeyword.TenDanhMuc%></div></div>
        <div class="control">
