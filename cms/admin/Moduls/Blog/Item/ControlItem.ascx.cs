...
public partial class cms_admin_Moduls_Blog_Item_ControlItem : System.Web.UI.UserControl
{
    protected string app = CodeApplications.Blog;
    ...
    void GetBlog(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
                                                      ...
                                                      LinkAdmin.UrlAdmin(CodeApplications.Blog, TypePage.Item,
    ...
    void GetGroupsInDdl()
    {
        ...
        ddlCateSearch.Items.Add(new ListItem(Developer.BlogKeyword.TatCaDanhMuc, ""));
    ...
    {
        string key = tbKeySearch.Text + "&name=" + tbTitleSearch.Text;
        Response.Redirect(LinkAdmin.GoAdminCategory(CodeApplications.Blog, TypePage.Item, ddlCateSearch.SelectedValue,
