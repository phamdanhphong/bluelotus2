...
public partial class cms_admin_Moduls_Blog_PopUp_Items_ViewCommentsReply : System.Web.UI.Page
{
    string top = "";
    string field = "";
    string condition = "";
    ...
    string app = CodeApplications.BlogComment + "Reply";
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/Blog/Item/Popup/ViewComments.aspx?iid=" + iid + "&isid=" + isid);
    }
}