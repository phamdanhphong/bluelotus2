...
public partial class cms_admin_Moduls_Blog_Item_SubControl_SubControlComment : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle = "Phản hồi "+BlogKeyword.Blog2+" mới";
    private string app = CodeApplications.BlogComment;
