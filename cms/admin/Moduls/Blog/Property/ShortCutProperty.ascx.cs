...
public partial class cms_admin_Moduls_Blog_Property_ShortCutProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.BlogProperty;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Blog, TypePage.Property, DdlGroupBlog.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.BlogKeyword.CapNhatThuocTinh;
        ...
        {
            LtInsertUpdate.Text = Developer.BlogKeyword.TaoThuocTinhMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
