...
public partial class cms_admin_Moduls_Blog_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.BlogKeyword.CapNhatNhomBlog;
        ...
        {
            LtInsertUpdate.Text = Developer.BlogKeyword.TaoNhomMoi;
            btn_insert_update.Text = "Đồng ý";
