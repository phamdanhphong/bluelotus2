...
<div id="AdmControlsConfig">
    ...
    <div class="fwb pb10">Cấu hình số lượng</div>   
     <div class="cbh20"><!----></div>
    <div class="fl pl20">Số tin tức trên trang chủ:</div>                
    <div class="fl fr20">
        <asp:TextBox ID="tbSoNewsTrenTrangChu" runat="server"></asp:TextBox>
    ...
    <div class="cbh20"><!----></div>
    <div class="fl pl20">Số tin tức trên trang danh mục:</div> 
    <div class="fl pr20">
        <asp:TextBox ID="tbSoNewsTrenTrangDanhMuc" runat="server"></asp:TextBox>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
            ErrorMessage="Vui lòng số tự nhiên(vd: 6)" ControlToValidate="tbSoNewsTrenTrangDanhMuc" 
            Display="Dynamic" SetFocusOnError="True" ValidationExpression="\d*"></asp:RegularExpressionValidator>
    </div>
    <div class="cbh20"><!----></div>
    <div class="fl pl20">Số tin tức khác trên một trang:</div>                
    <div class="fl pr20">
        <asp:TextBox ID="tbSoNewsKhacTrenMotTrang" runat="server"></asp:TextBox>
