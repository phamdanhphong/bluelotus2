...
public partial class cms_admin_Moduls_New_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.NewKeyword.CapNhatNhomTinTuc;
        ...
        {
            LtInsertUpdate.Text = Developer.NewKeyword.TaoNhomMoi;
            btn_insert_update.Text = "Đồng ý";
