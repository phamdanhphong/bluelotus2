<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Loadcontrol.ascx.cs" Inherits="cms_admin_New_Loadcontrol" %>
...
<div id="NewsModul">
    <div id="AdmRoad">
        ...
        <a title="Trang chủ" class="TextRoad arrow" href="<%=TatThanhJsc.NewsModul.Link.LnkMnNews() %>"><%=NewKeyword.New1 %></a>
        <div class="cbh0"><!----></div>
    
        <a class="config" href="<%=TatThanhJsc.NewsModul.Link.LnkMnNewsConfig() %>" title="Click để cấu hình cho trang này"><span class="iconConfig dib">&nbsp;</span></a>
    </div>
