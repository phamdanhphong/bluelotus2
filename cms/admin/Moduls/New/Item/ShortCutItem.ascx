<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutItem.ascx.cs" Inherits="cms_admin_Moduls_New_Item_ShortCutItem" %>
<%@ Import Namespace="Developer" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<%@ Register src="../../../../api/New/Item/Index.ascx" tagname="Index" tagprefix="uc1" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">    
    <link href="~/cms/admin/Moduls/New/Item/ShortCutItem/_cs.css" rel="stylesheet" type="text/css" />
</cc1:StyleSheetCombiner>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<asp:HiddenField ID="hdOldNew" runat="server" Value=""/>
...
<div id="admscitem">
    ...
    <div class="text"><div class="pt5"><%=NewKeyword.DanhMucCha%></div></div>
    <div class="control"><asp:DropDownList ID="ddl_group_product" runat="server" Width="222px"></asp:DropDownList> </div>
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=NewKeyword.TieuDe%></div></div>
    <div class="control">
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=NewKeyword.Ma%></div></div>
    <div class="control">
        <asp:TextBox ID="tbKey" runat="server" Width="400px"></asp:TextBox>        
    </div>

    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=NewKeyword.MoTa%></div></div>
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=NewKeyword.NgayDang%></div></div>
    <div>
    ...
    <div class="cbh8"><!----></div> 
    <div class="text"><div class="pt5"><%=NewKeyword.ThuTu%></div></div>
    <div class="control">
    ...
    <div class="dn">
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=NewKeyword.DangBoi%></div></div>
        <div>
            <asp:TextBox ID="txtAuthor" runat="server" Width="400px"></asp:TextBox>
        </div>
    </div>

    <div class="cbh8"><!----></div>
    <div class="cbh8"><!----></div>
    <div style="float: left" class="text"><%=NewKeyword.AnhDaiDien%></div>
    ...
    <div class="dn">
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=NewKeyword.MoTaHinhAnh%></div></div>
    ...
    <div class="cbh10"><!----></div>
    <div><CKEditor:CKEditorControl ID="txt_content" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&path=pic/New"></CKEditor:CKEditorControl></div>        
    <div class="cbh10"><!----></div>       
                                
    <asp:Panel ID="pnThuocTinhTinTuc" runat="server">
    <div class="cbh8"><!----></div>        
    <div><%=Developer.NewKeyword.ThuocTinhTinTuc%></div>
    <div class="cbh8"><!----></div>
    <div class="ThuocTinhTinTuc">
    ...
    <div class="KhungToiUu PdKhungToiUu">
        <div class="TextSeoLink"><%=NewKeyword.ToiUuTimKiem%> </div>
        <div>
            <div class="text"><div class="pt5"><%=NewKeyword.ToiUuTheTieuDe%> </div></div>
            ...
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=NewKeyword.ToiUuTheMoTa%> </div></div>
            <div class="control1"><asp:TextBox ID="textTagDescription" runat="server" Width="550px" Height="50px" TextMode="MultiLine" CssClass="tbDesc_Seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=NewKeyword.ToiUuTheTuKhoa%> </div></div>
            <div class="control1"><asp:TextBox ID="textTagKeyword" runat="server" Width="400px" CssClass="tbKeyword_seo"></asp:TextBox></div>
            <div class="dn">
                <div class="cbh8"><!----></div>
                <div class="text"><div class="pt5"><%=NewKeyword.Tag%> </div></div>
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><%=NewKeyword.TrangThai%></div>
