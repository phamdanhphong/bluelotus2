...
public partial class cms_admin_Moduls_New_PopUp_Items_ViewCommentsReply : System.Web.UI.Page
{
    string top = "";
    string field = "";
    string condition = "";
    ...
    string app = CodeApplications.NewsComment + "Reply";
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/New/Item/Popup/ViewComments.aspx?iid=" + iid + "&isid=" + isid);
    }
}