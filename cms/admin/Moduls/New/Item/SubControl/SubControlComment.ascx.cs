...
public partial class cms_admin_Moduls_New_Item_SubControl_SubControlComment : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle = "Phản hồi "+NewKeyword.New2+" mới";
    private string app = CodeApplications.NewsComment;
