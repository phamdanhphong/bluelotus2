...
public partial class cms_admin_Moduls_New_Property_ShortCutProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.NewsProperty;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.News, TypePage.Property, DdlGroupNew.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.NewKeyword.CapNhatThuocTinh;
        ...
        {
            LtInsertUpdate.Text = Developer.NewKeyword.TaoThuocTinhMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
