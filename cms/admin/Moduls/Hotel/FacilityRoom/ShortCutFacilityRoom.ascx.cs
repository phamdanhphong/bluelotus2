...
public partial class cms_admin_Moduls_Hotel_FacilityRoom_ShortCutFacilityRoom : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    protected string app = CodeApplications.HotelFacilityRoom;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (suc.Equals(TypePage.CreateFacilityRoom))
            insert = true;
        ...
        flAnhDaiDien.App = CodeApplications.Hotel;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Hotel, TypePage.FacilityRoom, ddlParentCate.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.HotelKeyword.CapNhatDanhMuc;
            btOK.Text = "Đồng ý";
        ...
        {
            LtInsertUpdate.Text = Developer.HotelKeyword.TaoDanhMuc;
            btOK.Text = "Đồng ý";
            tbTitle.Focus();
        }
        #endregion
