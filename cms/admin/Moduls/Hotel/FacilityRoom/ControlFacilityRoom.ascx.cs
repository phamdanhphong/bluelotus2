...
public partial class cms_admin_Moduls_Hotel_FacilityRoom_ControlFacilityRoom : System.Web.UI.UserControl
{
    private string lang = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();

    private string app = CodeApplications.HotelFacilityRoom;    
    ...
    {        
        return Link.LnkMnHotelFacilityRoomCreate();
    }
