...
<div id="ControlsConfig">    
    ...
    <div class="smalltextbox">
        <div class="fl pl20">Số <%= HotelKeyword.Hotel2 %> trên trang chủ:</div>
        <div class="fl pl10">
            <asp:TextBox ID="tbSoHotelTrenTrangChu" runat="server"></asp:TextBox>
        ...
        <div class="cb h20"><!----></div>
        <div class="fl pl20">Số <%= HotelKeyword.Hotel2 %> trên trang danh mục:</div>
        <div class="fl pl10">
            <asp:TextBox ID="tbSoHotelTrenTrangDanhMuc" runat="server"></asp:TextBox>
        ...
        <div class="cb h20"><!----></div>
        <div class="fl pl20">Số <%= HotelKeyword.Hotel2 %> khác trên một trang:</div>
        <div class="fl pl10">
            <asp:TextBox ID="tbSoHotelKhacTrenMotTrang" runat="server"></asp:TextBox>
