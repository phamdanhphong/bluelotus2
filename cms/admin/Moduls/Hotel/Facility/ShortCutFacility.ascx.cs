...
public partial class cms_admin_Moduls_Hotel_Facility_ShortCutFacility : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    protected string app = CodeApplications.HotelFacility;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (suc.Equals(TypePage.CreateFacility))
            insert = true;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Hotel, TypePage.Facility, ddlParentCate.SelectedValue);
    }
