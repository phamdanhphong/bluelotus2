<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutGroupItem.ascx.cs" Inherits="cms_admin_Moduls_Hotel_GroupItem_ShortCutGroupItem" %>
...
<div id="ShortCutCate" class="InsertPanel InitQuikMenu">
    ...
    <div class="controlBox">
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.HotelKeyword.ViTri%></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.HotelKeyword.TenNhom %></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.HotelKeyword.MoTa%></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.HotelKeyword.SoHotelDuocHienThi %></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.HotelKeyword.ThuTu %></div>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="text">
                <div class="pt5"><%=Developer.HotelKeyword.TrangThai %></div>
            </div>
            <div class="control">            
