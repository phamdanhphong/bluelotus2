...
public partial class cms_admin_Moduls_Hotel_Item_RecycleItem : System.Web.UI.UserControl
{
    ...
    void GetHotel(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
                                                      ...
                                                      LinkAdmin.UrlAdmin(CodeApplications.Hotel, TypePage.RecycleItem,
    ...
    void GetParentCate()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ddl_group_ontab.Items.Add(new ListItem(Developer.HotelKeyword.TatCaDanhMuc, ""));
