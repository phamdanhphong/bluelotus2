...
public partial class cms_admin_Moduls_Hotel_Item_ControlItem : System.Web.UI.UserControl
{
    protected string app = CodeApplications.Hotel;
    protected string appCate = CodeApplications.Hotel;
    protected string pic = FolderPic.Hotel;
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string sortCookiesName = SortKey.SortHotelItems;
    private string p = "1";
    ...
    protected string LinkUpdate(string iid)
    {
        ...
        {
            return LinkAdmin.GoAdminItem(CodeApplications.Hotel, TypePage.UpdateItem, iid, NumberShowItem, p);
        }
        else
        {
            return LinkAdmin.GoAdminItem(CodeApplications.Hotel, TypePage.UpdateItem, iid);
        }
    }
    ...
    protected string LinkCreate()
    {
        ...
        return LinkAdmin.GoAdminCategory(CodeApplications.Hotel, TypePage.CreateItem, igidUpdate);
    }
    ...
    void GetItems(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
            ...
            LinkAdmin.UrlAdmin(CodeApplications.Hotel, TypePage.Item,
    ...
    void GetParentCate()
    {
        ...
        ddlCateSearch.Items.Add(new ListItem(Developer.HotelKeyword.TatCaDanhMuc, ""));
    ...
    {
        string key = tbKeySearch.Text + "&name=" + tbTitleSearch.Text;
        Response.Redirect(LinkAdmin.GoAdminCategory(CodeApplications.Hotel, TypePage.Item, ddlCateSearch.SelectedValue,
