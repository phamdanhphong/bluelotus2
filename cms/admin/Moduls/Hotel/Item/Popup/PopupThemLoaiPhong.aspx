<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopupThemLoaiPhong.aspx.cs" Inherits="cms_admin_Moduls_Hotel_Item_Popup_PopupThemLoaiPhongAspx" ValidateRequest="false" %>
...
<head runat="server">
    <title>Thêm mới, chỉnh sửa loại phòng</title>    
...
<body style="margin:0;padding:0;background:#fff">
    ...
    <div class="InsertPanel">
        ...
        <div class="controlBox">
            <div class="row">
                <div class="text">Loại phòng</div>
                <div class="control">
                    <asp:TextBox ID="tbLoaiPhong" runat="server" placeholder="VD: Deluxe Twin Room"></asp:TextBox>                    
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                            ErrorMessage="*" SetFocusOnError="True" Display="Dynamic" ControlToValidate="tbLoaiPhong">
            ...
            <div class="row">
                ...
                <div class="control">
                    <asp:TextBox ID="tbGiaNiemYet" runat="server" CssClass="autoNumeric"></asp:TextBox> /1 phòng/1 đêm
                </div>
            </div>
            <div class="row">
                <div class="text"><%= HotelKeyword.GiaKhuyenMai %></div>
                <div class="control">
                    <asp:TextBox ID="tbGiaKhuyenMai" runat="server" CssClass="autoNumeric"></asp:TextBox> /1 phòng/1 đêm
                </div>
            </div>
            <div class="row">
                <div class="text">Tiện ích phòng</div>
            ...
            <div class="row">
                <div class="text">Có thể trả lại phòng không (refundable)</div>
                <div class="control">
            ...
            <div class="row">
                <div class="text">Diện tích phòng</div>
                <div class="control">
