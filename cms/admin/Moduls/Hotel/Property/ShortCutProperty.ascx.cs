...
public partial class cms_admin_Moduls_Hotel_Property_ShortCutProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    protected string app = CodeApplications.HotelProperty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (suc.Equals(TypePage.CreateProperty))
            insert = true;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Hotel, TypePage.Property, ddlParentCate.SelectedValue);
    }
