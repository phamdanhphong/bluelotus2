<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddItemToGroups.aspx.cs" Inherits="cms_admin_Service_SubControls_AddItemToGroups" %>
        ...
        <ContentTemplate>
            <div id="PopupAddItem">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr valign="top">
                        <td style="width:45%">
                            <div class="TitleListBox">Các nhóm dịch vụ đã trực thuộc</div>
                        ...
                        <td style="width:45%">
                            <div class="TitleListBox">Các nhóm dịch vụ chưa trực thuộc</div>
