<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SubControlItemHostest.ascx.cs" Inherits="cms_admin_Moduls_Service_Item_SubControl_SubControlItemHostest" %>
<%@ Import Namespace="TatThanhJsc.AdminModul" %>
<%@ Import Namespace="TatThanhJsc.ServiceModul" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">    
    <link href="~/cms/admin/Moduls/Service/Item/SubControl/SubControlItemHostest/_cs.css" rel="stylesheet" type="text/css" />   
</cc1:StyleSheetCombiner>

<asp:UpdatePanel ID="UpdatePanel1" runat="server">
<ContentTemplate>
<div id="SubServiceItemHostest">    
    <div class="header">
            ...
            <ItemTemplate>
                <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
                    ...
                    <div class="fr tool">      
                        ...
                        <a title="Cập nhật" href="<%#LinkAdmin.GoAdminItem(CodeApplications.Service, TypePage.UpdateItem, Eval("IID").ToString())%>"><span class="iconEdit"><!----></span></a>
