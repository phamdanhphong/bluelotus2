<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleItem.ascx.cs" Inherits="cms_admin_Moduls_Service_Item_RecycleItem" %>
...
<div id="admitem">
    <div class="BgTabTool">        
        <a href="javascript:DeleteRecListItems('<%=pic %>')" class="LinkDelete"><%=Developer.ServiceKeyword.Xoa%></a>                   
        <div class="right dn">            
            <div class="fl pr5">
    ...
    <div class="BgTabTitle" align="center">
        ...
        <div class="split">|</div>                    
        <div class="cot4">
            <asp:LinkButton ID="lbtView" runat="server" onclick="lbtView_Click" CssClass="arrowSort" ToolTip="Click để sắp xếp danh sách theo trường này"><%=Developer.ServiceKeyword.LuotXem%></asp:LinkButton>
        </div>                
        <div class="split">|</div>                    
        <div class="cot5">
