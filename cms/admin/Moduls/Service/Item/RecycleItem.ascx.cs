...
public partial class cms_admin_Moduls_Service_Item_RecycleItem : System.Web.UI.UserControl
{
    ...
    void GetGroupsInDdl()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ddl_group_ontab.Items.Add(new ListItem(Developer.ServiceKeyword.TatCaDanhMuc, ""));
