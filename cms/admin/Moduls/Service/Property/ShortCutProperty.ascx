<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutProperty.ascx.cs" Inherits="cms_admin_Moduls_Service_Property_ShortCutProperty" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Service/Property/ShortCutProperty/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admsccate">
    ...
    <div class="pdControl">
        ...
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.ServiceKeyword.TenThuocTinh%></div></div>
        <div class="control">
        ...
        <div class="text"><div class="pt5"><%=Developer.ServiceKeyword.Loai%></div></div>
        <div class="control">
