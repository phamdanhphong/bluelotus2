...
public partial class cms_admin_Moduls_Service_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.ServiceKeyword.CapNhatNhomDichVu;
        ...
        {
            LtInsertUpdate.Text = Developer.ServiceKeyword.TaoNhomMoi;
            btn_insert_update.Text = "Đồng ý";
