...
public partial class cms_admin_Moduls_Video_Property_RecycleProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();

    private string Modul = CodeApplications.VideoProperty;
    protected string pic = FolderPic.Video;
