...
public partial class cms_admin_Moduls_Video_Property_ShortCutProperty : System.Web.UI.UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Video, TypePage.Property, DdlGroupVideo.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.VideoKeyword.CapNhatThuocTinh;
        ...
        {
            LtInsertUpdate.Text = Developer.VideoKeyword.TaoThuocTinhMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
