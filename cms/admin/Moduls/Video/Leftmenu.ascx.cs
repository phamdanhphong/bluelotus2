...
public partial class cms_admin_Video_AdmLeftmenu : System.Web.UI.UserControl
{    
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        PhManagerApi.Controls.Add(LoadControl("../../../api/Video/Leftmenu.ascx"));
    ...
    {
        //Ẩn hiện menu Quản lý thuộc tính video
        if (VideoConfig.KeyHienThiQuanLyThuocTinhVideo)
        {
            pnThuocTinhVideo.Visible = true;
            pnThuocTinhVideo_ThemMoi.Visible = true;
            pnThuocTinhVideo_ThungRac.Visible = true;
        }
        else
        {
            pnThuocTinhVideo.Visible = false;
            pnThuocTinhVideo_ThemMoi.Visible = false;
            pnThuocTinhVideo_ThungRac.Visible = false;
        }               
        //Ẩn hiện menu Quản lý phản hồi
        if (VideoConfig.KeyHienThiQuanLyPhanHoiVideo) pnDanhSachPhanHoi.Visible = true;
        else pnDanhSachPhanHoi.Visible = false;

        //Ẩn hiện menu Thống kê báo cáo
        if (VideoConfig.KeyHienThiThongKeBaoCaoVideo) pnThongKeBaoCao.Visible = true;
