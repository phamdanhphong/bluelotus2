...
public partial class cms_admin_Moduls_Video_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.VideoKeyword.CapNhatNhomVideo;
        ...
        {
            LtInsertUpdate.Text = Developer.VideoKeyword.TaoNhomMoi;
            btn_insert_update.Text = "Đồng ý";
