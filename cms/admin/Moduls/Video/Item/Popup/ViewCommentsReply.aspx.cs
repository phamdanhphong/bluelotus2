...
public partial class cms_admin_Moduls_Video_PopUp_Items_ViewCommentsReply : System.Web.UI.Page
{
    string top = "";
    string field = "";
    string condition = "";
    ...
    string app = CodeApplications.VideoComment + "Reply";
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/Video/Item/Popup/ViewComments.aspx?iid=" + iid + "&isid=" + isid);
    }
}