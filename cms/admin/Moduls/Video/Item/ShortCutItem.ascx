<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutItem.ascx.cs" Inherits="cms_admin_Moduls_Video_Item_ShortCutItem" %>
<%@ Import Namespace="Developer" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">    
    <link href="~/cms/admin/Moduls/Video/Item/ShortCutItem/_cs.css" rel="stylesheet" type="text/css" />
</cc1:StyleSheetCombiner>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<asp:HiddenField ID="hdOldVideo" runat="server" Value=""/>
...
<div id="admscitem">
    ...
    <div class="text"><div class="pt5"><%=VideoKeyword.DanhMucCha%></div></div>
    <div class="control"><asp:DropDownList ID="ddl_group_product" runat="server" Width="222px"></asp:DropDownList> </div>
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=VideoKeyword.TieuDe%></div></div>
    <div class="control">
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=VideoKeyword.Ma%></div></div>
    <div class="control">
        <asp:TextBox ID="tbKey" runat="server" Width="400px"></asp:TextBox>        
    </div>

    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=VideoKeyword.MoTa%></div></div>
    ...
    <div class="text"><div class="pt5"><%=VideoKeyword.MaChiSe%></div></div>
    <div class="box">
        <asp:TextBox ID="txt_youtubecode" runat="server" Width="600px" Height="60px"  TextMode="MultiLine"></asp:TextBox>
        <div>
    ...
    <div class="text"><div class="pt5"><%=VideoKeyword.NgayDang%></div></div>
    <div>
    ...
    <div class="cbh8"><!----></div>    
    <div class="text"><div class="pt5"><%=VideoKeyword.ThuTu%></div></div>
    <div class="control">
    ...
    <div class="dn">
            <div class="cbh8"><!----></div>
    <div style="float: left" class="text"><%=VideoKeyword.AnhDaiDien%></div>
    ...
    <div class="dn">
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=VideoKeyword.MoTaHinhAnh%></div></div>
    ...
    <div><%=VideoKeyword.ChiTiet%></div>
    <div class="cbh10"><!----></div>
    <div><CKEditor:CKEditorControl ID="txt_content" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&path=pic/Video"></CKEditor:CKEditorControl></div>        
    <div class="cbh10"><!----></div>       
                                
    <asp:Panel ID="pnThuocTinhVideo" runat="server">
    <div class="cbh8"><!----></div>        
    <div><%=Developer.VideoKeyword.ThuocTinhVideo%></div>
    <div class="cbh8"><!----></div>
    <div class="ThuocTinhVideo">
    ...
    <div class="KhungToiUu PdKhungToiUu">
        <div class="TextSeoLink"><%=VideoKeyword.ToiUuTimKiem%> </div>
        <div>
            <div class="text"><div class="pt5"><%=VideoKeyword.ToiUuTheTieuDe%> </div></div>
            <div class="control1"><asp:TextBox ID="textTagTitle" runat="server" Width="400px" CssClass="tbTitle_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=VideoKeyword.ToiUuDuongDan%> </div></div>
            <div class="control1"><asp:TextBox ID="textLinkRewrite" runat="server" Width="400px" CssClass="tbLink_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=VideoKeyword.ToiUuTheMoTa%> </div></div>
            <div class="control1"><asp:TextBox ID="textTagDescription" runat="server" Width="550px" Height="50px" CssClass="tbDesc_Seo" TextMode="MultiLine"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=VideoKeyword.ToiUuTheTuKhoa%> </div></div>
            <div class="control1"><asp:TextBox ID="textTagKeyword" runat="server" Width="400px" CssClass="tbKeyword_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="dn">
                  <div class="text"><div class="pt5"><%=VideoKeyword.Tag%> </div></div>
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><%=VideoKeyword.TrangThai%></div>
