<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SubControlItemLastest.ascx.cs" Inherits="cms_admin_Moduls_Video_Item_SubControl_SubControlItemLastest" %>
<%@ Import Namespace="TatThanhJsc.AdminModul" %>
<%@ Import Namespace="TatThanhJsc.VideoModul" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">    
    <link href="~/cms/admin/Moduls/Video/Item/SubControl/SubControlItemLastest/_cs.css" rel="stylesheet" type="text/css" />   
</cc1:StyleSheetCombiner>

<asp:UpdatePanel ID="UpdatePanel1" runat="server">
<ContentTemplate>
<div id="SubVideoItemLastest">    
    <div class="header">
