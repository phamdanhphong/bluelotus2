...
public partial class cms_admin_Moduls_Video_Item_SubControl_SubControlItemLastest : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle =VideoKeyword.Video1 + " mới cập nhật";
