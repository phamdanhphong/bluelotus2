<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleGroupItem.ascx.cs" Inherits="cms_admin_Moduls_Content_GroupItem_RecycleGroupItem" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Content/GroupItem/RecycleGroupItem/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="ContentRecycleCate">
    ...
    <div class="BgTabTitle" align="center">
        ...
        <div class="split">|</div>
        <div class="cot2" align="left"><%=Developer.ContentKeyword.TieuDeNhom %></div>
        <div class="split">|</div>
