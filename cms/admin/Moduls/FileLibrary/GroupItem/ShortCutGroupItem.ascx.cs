...
public partial class cms_admin_Moduls_FileLibrary_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.FileLibraryKeyword.CapNhatNhomDuLieu;
        ...
        {
            LtInsertUpdate.Text = Developer.FileLibraryKeyword.TaoNhomMoi;
            btn_insert_update.Text = "Đồng ý";
