...
public partial class cms_admin_Moduls_FileLibrary_Item_SubControl_SubControlComment : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle = "Phản hồi "+FileLibraryKeyword.FileLibrary2+" mới";
    private string app = CodeApplications.FileLibraryComment;
