...
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server"><link href="~/cms/admin/Moduls/FileLibrary/Item/ControlItem/_cs.css" rel="stylesheet" type="text/css" /></cc1:StyleSheetCombiner>
...
<div id="admitem">
    ...
    <div class="BgTabTitle" align="center">
        ...
        <div class="split">|</div>                    
        <div class="fr pr5"><%=Developer.FileLibraryKeyword.CongCu %></div>                    
        <div class="cb"><!----></div>
    </div>
                ...
                <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
                    <div class="bgItem">
                        ...
                        <div class="fr tool pr5">
                            <a class="<%=FileLibraryConfig.KeyHienThiQuanLyPhanHoiDuLieu %>" href="javascript:NewWindow_('cms/admin/Moduls/FileLibrary/Item/PopUp/ViewComments.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconPhanHoi'><!----></span></a>                            
                            
                            <a class="<%=FileLibraryConfig.KeyHienThiThemNhieuFile %>" title="<%=Developer.FileLibraryKeyword.ClickDeThemFile %>" href="javascript:NewWindow_('cms/admin/Moduls/FileLibrary/Item/PopUp/AddEmmbedFileToItems.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconThemFile'><!----></span></a>

                            <a class="<%=TagConfig.KeyHienThiTagChoFileLibrary%>" title="Click để thêm tag" href="javascript:NewWindow_('cms/admin/TempControls/PopUp/Items/AddTags.aspx?iid=<%#Eval("IID")%>&Modul=<%=app %>','ImageList','950','600','yes','yes')"><span class='iconThemTag'><!----></span></a>

                            <a title="<%=Developer.FileLibraryKeyword.ClickDeThemVaoNhom %>" href="javascript:NewWindow_('cms/admin/Moduls/FileLibrary/Item/Popup/AddItemToGroups.aspx?iid=<%#Eval("IID")%>','ImageList','800','450','yes','yes')"><span class='iconThemVaoNhom'><!----></span></a>                                                        
