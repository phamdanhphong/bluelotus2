...
public partial class cms_admin_Moduls_FileLibrary_PopUp_Items_ViewCommentsReply : System.Web.UI.Page
{
    string top = "";
    string field = "";
    string condition = "";
    ...
    string app = CodeApplications.FileLibraryComment + "Reply";
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/FileLibrary/Item/Popup/ViewComments.aspx?iid=" + iid + "&isid=" + isid);
    }
}