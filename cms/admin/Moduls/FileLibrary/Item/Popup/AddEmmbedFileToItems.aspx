<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddEmmbedFileToItems.aspx.cs" Inherits="cms_admin_ModulMain_FileLibrary_PopUp_Items_AddEmmbedFileToItems" ValidateRequest="false"%>
...
<body>
    ...
    <div class="w900 ma ffTahoma fs12">        
        ...
        <div class='pb5'>
            ...
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/FileLibrary/Item/Popup/AddEmmbedFileToItems/swfupload/swfupload.js"></script>
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/FileLibrary/Item/Popup/AddEmmbedFileToItems/swfupload/handlers.js"></script>
            <script type="text/javascript">
                var swfu;
                window.onload = function () {
                    ...
                    swfu = new SWFUpload({
                        // Backend Settings            
                        upload_url: weburl + "cms/admin/Moduls/FileLibrary/Item/Popup/AddEmmbedFileToItems/upload.aspx?iid=" + iid,
                        post_params: {
                        ...
                        // Button settings
                        button_image_url: weburl + "cms/admin/Moduls/FileLibrary/Item/Popup/AddEmmbedFileToItems/swfupload/btupload.png",
                        ...
                        // Flash Settings
                        flash_url: weburl + "cms/admin/Moduls/FileLibrary/Item/Popup/AddEmmbedFileToItems/swfupload/swfupload.swf", // Relative to this file
        ...
        <div class="fl w120"><%=FileLibraryKeyword.TepDinhKem%></div>
