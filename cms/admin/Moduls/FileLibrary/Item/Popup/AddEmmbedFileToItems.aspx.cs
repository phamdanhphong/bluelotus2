...
public partial class cms_admin_ModulMain_FileLibrary_PopUp_Items_AddEmmbedFileToItems : System.Web.UI.Page
{
    string top = "";
    string fields = "";
    string orderby = "";
    string condition = "";
    string app = CodeApplications.FileLibraryEmmbedFilesOther;
    string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    protected string iid = "";
    string pathFolderPic = FolderPic.FileLibrary;
...
";
    ...
    protected void btCancel_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/FileLibrary/Item/PopUp/AddEmmbedFileToItems.aspx?iid=" + iid);
    }
    void GetList()
    {
    ...
    protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        switch (c)
        {
            ...
            case "edit":
                //OpenUpdatePanel(p);
                Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/FileLibrary/Item/PopUp/AddEmmbedFileToItems.aspx?iid=" + iid + "&isid=" + p);
                break;
            #endregion
        }
    }
