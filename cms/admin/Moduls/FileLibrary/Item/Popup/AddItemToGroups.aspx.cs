...
public partial class cms_admin_FileLibrary_SubControls_AddItemToGroups : System.Web.UI.Page
{
    ...
    void GetTitleItem()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lt_cate_name.Text =@"
<div class='TitleItem'>Tên dữ liệu: " + dt.Rows[0]["VITITLE"].ToString() + @"</div>
<div>Ngày đăng: " +TatThanhJsc.Extension.TimeExtension.FormatTime(dt.Rows[0][TatThanhJsc.Columns.ItemsColumns.DicreatedateColumn],"dd/MM/yyyy") + @"</div>";
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        ...
        {
            LtMes.Visible = true;
            LtMes.Text = "<div class='MesText'>Dữ liệu đã trong nhóm <b>" + GroupsExtension.GetNameCategoryById(lstadded.SelectedValue) + "</b></div>";
            return;
        }
    }
    ...
    protected void btnremove_Click(object sender, EventArgs e)
    {
        ...
        {
            LtMes.Visible = true;
            LtMes.Text = "<div class='MesText'>Dữ liệu này chưa trong nhóm <b>" + GroupsExtension.GetNameCategoryById(lstnotadded.SelectedValue) + "</b></div>";
            return;
        }
    }
