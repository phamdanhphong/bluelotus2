...
public partial class cms_admin_Moduls_FileLibrary_Item_ShortCutItem : System.Web.UI.UserControl
{
    private string app = CodeApplications.FileLibrary;
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string pic = FolderPic.FileLibrary;
    private string propertyModul = CodeApplications.FileLibraryProperty;
    ...
    {       
        ...
        if (FileLibraryConfig.KeyHienThiQuanLyThuocTinhDuLieu) pnThuocTinhDuLieu.Visible = true;
        else pnThuocTinhDuLieu.Visible = false;      
    }
    #endregion
    ...
    private string LinkRedrect()
    {
        ...
        {
            return UrlExtension.WebisteUrl + "admin.aspx?uc=" + CodeApplications.FileLibrary + "&igid=" + ddl_group_product.SelectedValue + "&suc="+TypePage.Item+"&ni=" + ni + "&p=" + p;
        }
        else
        {
            return UrlExtension.WebisteUrl + "admin.aspx?uc=" + CodeApplications.FileLibrary + "&igid=" + ddl_group_product.SelectedValue + "&suc=" + TypePage.Item;
        }
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            ...
            hdOldFileLibrary.Value = dt.Rows[0]["VICONTENT"].ToString();
            #region SEO
            ...
            #region ThuocTinhDuLieu-Chi thực hiện khi chức năng Quản lý thuộc tính được hiển thị
            if (FileLibraryConfig.KeyHienThiQuanLyThuocTinhDuLieu)
            {
                string properties = "";
                condition = TatThanhJsc.Extension.DataExtension.AndConditon(
