...
<div id="admscitem">
    ...
    <div class="text"><div class="pt5"><%=FileLibraryKeyword.DanhMucCha%></div></div>
    <div class="control"><asp:DropDownList ID="ddl_group_product" runat="server" Width="222px"></asp:DropDownList> </div>
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=FileLibraryKeyword.TieuDe%></div></div>
    <div class="control">
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=FileLibraryKeyword.Ma%></div></div>
    <div class="control">
        <asp:TextBox ID="tbKey" runat="server" Width="400px"></asp:TextBox>        
    </div>

    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=FileLibraryKeyword.MoTa%></div></div>
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=FileLibraryKeyword.NgayDang%></div></div>
    <div>
    ...
    <div class="text"><div class="pt5"><%=FileLibraryKeyword.ThuTu%></div></div>
    <div class="control">
    ...
    <div class="text"><div class="pt5"><%=FileLibraryKeyword.TepDinhKem%></div></div>
    ...
    <div class="dn">
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=FileLibraryKeyword.MoTaHinhAnh%></div></div>
    ...
    <div class="cbh10"><!----></div>
    <div><CKEditor:CKEditorControl ID="txt_content" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&path=pic/FileLibrary"></CKEditor:CKEditorControl></div>        
    <div class="cbh10"><!----></div>       
    ...
    <div class="KhungToiUu PdKhungToiUu">
        ...
        <div>
            ...
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=FileLibraryKeyword.ToiUuTheTuKhoa%> </div></div>
            <div class="control1"><asp:TextBox ID="textTagKeyword" runat="server" Width="400px" CssClass="tbKeyword_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="dn">
                <div class="text"><div class="pt5"><%=FileLibraryKeyword.Tag%> </div></div>
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><%=FileLibraryKeyword.TrangThai%></div>
