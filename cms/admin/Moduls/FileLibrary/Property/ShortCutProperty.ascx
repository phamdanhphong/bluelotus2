<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutProperty.ascx.cs" Inherits="cms_admin_Moduls_FileLibrary_Property_ShortCutProperty" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/FileLibrary/Property/ShortCutProperty/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admsccate">
    ...
    <div class="pdControl">
        ...
        <div class="text"><div class="pt5"><%=Developer.FileLibraryKeyword.DanhMucCha %></div></div>
        <div class="control"><asp:DropDownList ID="DdlGroupFileLibrary" runat="server" Width="252px"></asp:DropDownList></div>
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.FileLibraryKeyword.TenThuocTinh%></div></div>
        <div class="control">
        ...
        <div class="cbh8"><!----></div>         
        <div class="text"><div class="pt5"><%=Developer.FileLibraryKeyword.MoTa%>:</div></div>
        <div class="control">
            <asp:TextBox ID="txtDesc" runat="server" Width="580px" Height="50px" TextMode="MultiLine" CssClass="tbDesc"></asp:TextBox>                            
        </div>
        <div class="cbh8"><!----></div>         

        <div class="text"><div class="pt5"><%=Developer.FileLibraryKeyword.Loai%></div></div>
        <div class="control">
        ...
        <div class="text"><%=Developer.FileLibraryKeyword.AnhDaiDien%>:</div>
        ...
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.FileLibraryKeyword.ThuTu %>:</div></div>
        <div class="control">
        ...
        <div class="cb h8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.FileLibraryKeyword.TrangThai %>:</div></div>
        <div class="control">
        ...
        <div class="cbh20"><!----></div>
        <div class="TextSeoLink"><%=Developer.FileLibraryKeyword.ToiUuTimKiem%> </div>
        <div>
            <div class="text"><div class="pt5"><%=Developer.FileLibraryKeyword.ToiUuDuongDan%>: </div></div>
            <div class="control"><asp:TextBox ID="textLinkRewrite" runat="server" Width="450px" CssClass="tbLink_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.FileLibraryKeyword.ToiUuTheTieuDe%>: </div></div>
            <div class="control"><asp:TextBox ID="textTagTitle" runat="server" Width="450px" CssClass="tbTitle_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.FileLibraryKeyword.ToiUuTheTuKhoa%>: </div></div>
            <div class="control"><asp:TextBox ID="textTagKeyword" runat="server" Width="450px" CssClass="tbKeyword_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.FileLibraryKeyword.ToiUuTheMoTa%>: </div></div>
