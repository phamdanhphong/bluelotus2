...
public partial class cms_admin_Moduls_FileLibrary_Cate_ShortCutCate : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.FileLibraryKeyword.CapNhatDanhMuc;
            ...
            ltimg.Text = TatThanhJsc.Extension.ImagesExtension.GetImage(pic, dt.Rows[0]["VGIMAGE"].ToString(), "", "adm_img_FileLibrary", false, false, "", false);
        ...
        {
            LtInsertUpdate.Text = Developer.FileLibraryKeyword.TaoDanhMuc;
            btn_insert_update.Text = "Đồng ý";
