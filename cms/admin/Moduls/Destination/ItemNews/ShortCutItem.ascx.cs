...
public partial class cms_admin_Moduls_Destination_Item_ShortCutItem : System.Web.UI.UserControl
{
    ...
    protected void btOK_Click(object sender, EventArgs e)
    {
        ...
        if (insert)
        {
            ...
            GroupsItems.InsertItemsGroupsItems(language, app, "", tbTitle.Text, tbDesc.Text, contentDetail,
                image, "", "", tbSeoTitle.Text, tbSeoLink.Text, StringExtension.ReplateTitle(tbSeoLink.Text),
