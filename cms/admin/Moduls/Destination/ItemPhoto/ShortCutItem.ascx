<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutItem.ascx.cs" Inherits="cms_admin_Moduls_Destination_Item_ShortCutItemPhoto" %>
...
<div id="ShortCutItem" class="InsertPanel InitQuikMenu">
    ...
    <div class="controlBox">
        ...
        <div class="row">
            <div class="text"><%= DestinationKeyword.LinkẠmDanToi %></div>
            <div class="control">
                <asp:TextBox ID="tbAdvLink" runat="server"></asp:TextBox>                
            </div>
        </div>
        <div class="row">
            <div class="text"><%=AdvertisingKeyword.QuangCaoSeMoRa%></div>
            <div class="control">
                <asp:DropDownList ID="ddlMoTabMoi" runat="server" Width="280px">                                                
