<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleItem.ascx.cs" Inherits="cms_admin_Moduls_Destination_Item_RecycleItemVideo" %>
<%@ Import Namespace="TatThanhJsc.Columns" %>

<asp:HiddenField ID="hd_time" runat="server" />
<div id="ControlItem">
    <div class="BgTabTool">        
        <a href="javascript:DeleteRecListItems('<%=pic %>')" class="LinkDelete"><%=Developer.DestinationKeyword.Xoa%></a>                   
        <div class="right dn">            
            <div class="fl pr5">
