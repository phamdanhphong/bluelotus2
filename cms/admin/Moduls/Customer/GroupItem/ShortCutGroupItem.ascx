<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutGroupItem.ascx.cs" Inherits="cms_admin_Moduls_Customer_GroupItem_ShortCutGroupItem" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Customer/GroupItem/ShortCutGroupItem/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admsccate">
    ...
    <div class="pdControl">
        ...
        <div class="text"><div class="pt5"><%=Developer.CustomerKeyword.ViTri%></div></div>
        <div class="control"><asp:DropDownList ID="DdlPosition" runat="server" Width="252px"></asp:DropDownList></div>
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.CustomerKeyword.TenNhom %></div></div>
        <div class="control">
        ...
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.CustomerKeyword.SoCustomerDuocHienThi %>:</div></div>
        <div class="control">
