<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleGroupItem.ascx.cs" Inherits="cms_admin_Moduls_Customer_GroupItem_RecycleGroupItem" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/Customer/GroupItem/RecycleGroupItem/_cs.css" rel="stylesheet" type="text/css" />
