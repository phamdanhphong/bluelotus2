...
public partial class cms_admin_Moduls_Customer_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.CustomerKeyword.CapNhatNhomKhachHang;
        ...
        {
            LtInsertUpdate.Text = Developer.CustomerKeyword.TaoNhomMoi;
            btn_insert_update.Text = "Đồng ý";
