...
public partial class cms_admin_Moduls_Customer_Property_ShortCutProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.CustomerProperty;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Customer, TypePage.Property, DdlGroupCustomer.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.CustomerKeyword.CapNhatThuocTinh;
        ...
        {
            LtInsertUpdate.Text = Developer.CustomerKeyword.TaoThuocTinhMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
