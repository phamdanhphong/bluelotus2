...
public partial class cms_admin_Moduls_Customer_Property_RecycleProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();

    private string Modul = CodeApplications.CustomerProperty;
    protected string pic = FolderPic.Customer;
