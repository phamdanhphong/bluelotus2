...
public partial class cms_admin_Moduls_Customer_Item_RecycleItem : System.Web.UI.UserControl
{
    ...
    void GetCustomer(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
                                                      ...
                                                      LinkAdmin.UrlAdmin(CodeApplications.Customer, TypePage.RecycleItem,
    ...
    void GetGroupsInDdl()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ddl_group_ontab.Items.Add(new ListItem(Developer.CustomerKeyword.TatCaDanhMuc, ""));
