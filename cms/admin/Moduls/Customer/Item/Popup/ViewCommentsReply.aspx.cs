...
public partial class cms_admin_Moduls_Customer_PopUp_Items_ViewCommentsReply : System.Web.UI.Page
{
    string top = "";
    string field = "";
    string condition = "";
    ...
    string app = CodeApplications.CustomerComment + "Reply";
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/Customer/Item/Popup/ViewComments.aspx?iid=" + iid + "&isid=" + isid);
    }
}