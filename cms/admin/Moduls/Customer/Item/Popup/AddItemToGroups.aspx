<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddItemToGroups.aspx.cs" Inherits="cms_admin_Customer_SubControls_AddItemToGroups" %>
        ...
        <ContentTemplate>
            <div id="PopupAddItem">
                ...
                <div class="ColDropdownList">
                    <asp:DropDownList ID="ddl_type_groupnew_show" runat="server" AutoPostBack="true" Width="250px" onselectedindexchanged="ddl_type_groupnew_show_SelectedIndexChanged"></asp:DropDownList>
                </div>                
                <div class="cbh15"><!----></div>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr valign="top">
                        <td style="width:45%">
                            <div class="TitleListBox">Các nhóm khách hàng đã trực thuộc</div>
                        ...
                        <td style="width:45%">
                            <div class="TitleListBox">Các nhóm khách hàng chưa trực thuộc</div>
