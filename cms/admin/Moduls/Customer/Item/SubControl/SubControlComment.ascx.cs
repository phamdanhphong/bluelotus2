...
public partial class cms_admin_Moduls_Customer_Item_SubControl_SubControlComment : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle = "Phản hồi "+CustomerKeyword.Customer2+" mới";
    private string app = CodeApplications.CustomerComment;
