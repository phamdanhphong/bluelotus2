...
public partial class cms_admin_Moduls_Customer_Item_SubControl_SubControlItemLastest : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle =CustomerKeyword.Customer1+ " mới cập nhật";
