<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleItem.ascx.cs" Inherits="cms_admin_Moduls_AboutUs_Item_RecycleItem" %>

<asp:HiddenField ID="hd_time" runat="server" />
<div id="ControlItem">
    <div class="BgTabTool">        
        <a href="javascript:DeleteRecListItems('<%=pic %>')" class="LinkDelete"><%=Developer.AboutUsKeyword.Xoa%></a>                   
        <div class="right dn">            
            <div class="fl pr5">
    ...
    <div class="BgTabTitle" align="center">
        ...
        <div class="split">|</div>                    
        <div class="fr pr5"><%=Developer.AboutUsKeyword.CongCu %></div>                    
        <div class="cb"><!----></div>
    </div>
