...
public partial class cms_admin_Moduls_AboutUs_Item_ControlItem : System.Web.UI.UserControl
{
    protected string app = CodeApplications.AboutUs;
    protected string appCate = CodeApplications.AboutUs;
    protected string pic = FolderPic.AboutUs;
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string sortCookiesName = SortKey.SortAboutUsItems;
    private string p = "1";
    ...
    protected string LinkUpdate(string iid)
    {
        ...
        {
            return LinkAdmin.GoAdminItem(CodeApplications.AboutUs, TypePage.UpdateItem, iid, NumberShowItem, p);
        }
        else
        {
            return LinkAdmin.GoAdminItem(CodeApplications.AboutUs, TypePage.UpdateItem, iid);
        }
    }
    ...
    protected string LinkCreate()
    {
        ...
        return LinkAdmin.GoAdminCategory(CodeApplications.AboutUs, TypePage.CreateItem, igidUpdate);
    }
    ...
    void GetItems(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
            ...
            LinkAdmin.UrlAdmin(CodeApplications.AboutUs, TypePage.Item,
    ...
    void GetParentCate()
    {
        ...
        ddlCateSearch.Items.Add(new ListItem(Developer.AboutUsKeyword.TatCaDanhMuc, ""));
    ...
    {
        string key = tbKeySearch.Text + "&name=" + tbTitleSearch.Text;
        Response.Redirect(LinkAdmin.GoAdminCategory(CodeApplications.AboutUs, TypePage.Item, ddlCateSearch.SelectedValue,
