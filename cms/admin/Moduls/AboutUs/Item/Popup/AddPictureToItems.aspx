...
<body>
    ...
    <div class="w900 ma ffTahoma fs12">        
        ...
        <div class='pb5'>
            ...
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/AboutUs/Item/Popup/AddPictureToItems/swfupload/swfupload.js"></script>
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/AboutUs/Item/Popup/AddPictureToItems/swfupload/handlers.js"></script>
            <script type="text/javascript">
                var swfu;
                window.onload = function () {
                    ...
                    swfu = new SWFUpload({
                        // Backend Settings            
                        upload_url: weburl + "cms/admin/Moduls/AboutUs/Item/Popup/AddPictureToItems/upload.aspx?iid=" + iid+"&color="+color,
                        post_params: {
                        ...
                        // Button settings
                        button_image_url: weburl + "cms/admin/Moduls/AboutUs/Item/Popup/AddPictureToItems/swfupload/btupload.png",
                        ...
                        // Flash Settings
                        flash_url: weburl + "cms/admin/Moduls/AboutUs/Item/Popup/AddPictureToItems/swfupload/swfupload.swf", // Relative to this file
                ...
                <ItemTemplate>
                    <div class='pt5 pb5 bdbs'>
                        ...
                        <div class='fl w200 pl5'>
                            <%#ImagesExtension.GetImage(FolderPic.AboutUs, Eval(TatThanhJsc.Columns.SubitemsColumns.VsimageColumn).ToString(), "", "hotelImage", false, false, "")%>&nbsp;
                        </div>
