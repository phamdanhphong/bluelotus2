        ...
        if (Request.Params["iid"] != null)
        {
            ...
            {   
                ...
                if (SettingsExtension.GetSettingKey(SettingKey.HanCheKichThuocAnhAboutUs, lang) == "1")
                    ImagesExtension.ResizeImage(path + fileName, "", SettingsExtension.GetSettingKey(SettingKey.HanCheKichThuocAnhAboutUs_MaxWidth, lang), SettingsExtension.GetSettingKey(SettingKey.HanCheKichThuocAnhAboutUs_MaxHeight, lang));
                #endregion
                #region Đóng dấu ảnh
                if (SettingsExtension.GetSettingKey(SettingKey.DongDauAnhAboutUs, lang) == "1")
                {
                    ImagesExtension.CreateWatermark(path + fileName, path + SettingsExtension.GetSettingKey(SettingKey.DongDauAnhAboutUs_AnhDau, lang), SettingsExtension.GetSettingKey(SettingKey.DongDauAnhAboutUs_ViTri, lang), SettingsExtension.GetSettingKey(SettingKey.DongDauAnhAboutUs_LeNgang, lang), SettingsExtension.GetSettingKey(SettingKey.DongDauAnhAboutUs_LeDoc, lang), SettingsExtension.GetSettingKey(SettingKey.DongDauAnhAboutUs_TyLe, lang), SettingsExtension.GetSettingKey(SettingKey.DongDauAnhAboutUs_TrongSuot, lang));
                }
                #endregion
                ...
                if (SettingsExtension.GetSettingKey(SettingKey.TaoAnhNhoChoAnhAboutUs, lang) == "1")
                {
                    ...
                    ImagesExtension.ResizeImage(path + fileName, path + vimg_thumb, SettingsExtension.GetSettingKey(SettingKey.TaoAnhNhoChoAnhAboutUs_MaxWidth, lang), SettingsExtension.GetSettingKey(SettingKey.TaoAnhNhoChoAnhAboutUs_MaxHeight, lang));
