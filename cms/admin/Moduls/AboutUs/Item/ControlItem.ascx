                ...
                <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
                    <div class="bgItem">
                        ...
                        <div class="fr tool pr5">               
                             <a href="javascript:NewWindow_('cms/admin/Moduls/AboutUs/Item/Popup/AddPictureToItems.aspx?iid=<%#Eval("IID")%>','ImageList','1000','650','yes','yes')"><span class="iconThemAnh"><!----></span></a>                                  
