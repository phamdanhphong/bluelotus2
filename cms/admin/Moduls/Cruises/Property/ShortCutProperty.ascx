<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutProperty.ascx.cs" Inherits="cms_admin_Moduls_Cruises_Property_ShortCutProperty" %>
...
<div id="ShortCutCate" class="InsertPanel InitQuikMenu">
    ...
    <div class="controlBox">
        ...
        <div class="row">
            <div class="text"><%=Developer.CruisesKeyword.TenThuocTinh%></div>
            <div class="control">
