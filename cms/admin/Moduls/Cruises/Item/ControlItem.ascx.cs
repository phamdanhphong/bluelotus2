...
public partial class cms_admin_Moduls_Cruises_Item_ControlItem : System.Web.UI.UserControl
{
    protected string app = CodeApplications.Cruises;
    protected string appCate = CodeApplications.Cruises;
    protected string pic = FolderPic.Cruises;
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string sortCookiesName = SortKey.SortCruisesItems;
    private string p = "1";
    ...
    protected string LinkUpdate(string iid)
    {
        ...
        {
            return LinkAdmin.GoAdminItem(CodeApplications.Cruises, TypePage.UpdateItem, iid, NumberShowItem, p);
        }
        else
        {
            return LinkAdmin.GoAdminItem(CodeApplications.Cruises, TypePage.UpdateItem, iid);
        }
    }
    ...
    protected string LinkCreate()
    {
        ...
        return LinkAdmin.GoAdminCategory(CodeApplications.Cruises, TypePage.CreateItem, igidUpdate);
    }
    ...
    void GetItems(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
            ...
            LinkAdmin.UrlAdmin(CodeApplications.Cruises, TypePage.Item,
    ...
    void GetParentCate()
    {
        ...
        ddlCateSearch.Items.Add(new ListItem(Developer.CruisesKeyword.TatCaDanhMuc, ""));
    ...
    {
        string key = tbKeySearch.Text + "&name=" + tbTitleSearch.Text;
        Response.Redirect(LinkAdmin.GoAdminCategory(CodeApplications.Cruises, TypePage.Item, ddlCateSearch.SelectedValue,
