<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PopupThemLichTrinh.ascx.cs" Inherits="cms_admin_Moduls_Cruises_Item_Popup_PopupThemLichTrinh" %>
...
<div class="lightPopup" id="lightPopupLichTrinh">
    ...
    <asp:Panel ID="pnCoIid" runat="server" CssClass="lightPopupBox">
        <iframe frameborder="0" width="100%" src="<%= UrlExtension.WebisteUrl %>cms/admin/Moduls/Cruises/Item/Popup/PopupThemLichTrinh.aspx?iid=<%=iid %>"></iframe>
    </asp:Panel>
...
<script type="text/javascript">
    function ThemLichTrinh() {
        ...
        $(".lightPopup#lightPopupLichTrinh iframe").attr("src", "<%= UrlExtension.WebisteUrl %>cms/admin/Moduls/Cruises/Item/Popup/PopupThemLichTrinh.aspx?iid=<%=iid %>");
    ...
    function EditItinerary(isid) {
        $(".fadePopup#fadePopupLichTrinh").show();
        $(".lightPopup#lightPopupLichTrinh iframe").attr("src", "<%= UrlExtension.WebisteUrl %>cms/admin/Moduls/Cruises/Item/Popup/PopupThemLichTrinh.aspx?iid=<%=iid %>&isid=" + isid);
        $(".lightPopup#lightPopupLichTrinh").show();
    }
</script>
...
<script type="text/javascript">
    function LayDanhSachLichTrinh(iid) {
        loading(true);
        jQuery.ajax({
            url: weburl + "cms/admin/Moduls/Cruises/Item/Popup/PopupThemLichTrinhAjax.aspx",
            type: "POST",
            //dataType: "json",
            data: {
