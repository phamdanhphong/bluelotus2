...
public partial class cms_admin_Moduls_Cruises_Item_Popup_PopupThemCabinAspx : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if(isid == "")
                ltrHead.Text = "Thêm cabin";
            else
                ltrHead.Text = "Sửa cabin";
    ...
    private void InitialControlsValue()
    {
        ...
        if(isid != "")
        {
            ...
            if(dt.Rows.Count > 0)
            {
                tbCabin.Text = dt.Rows[0][SubitemsColumns.VstitleColumn].ToString();                
    ...
    {
        string app = CodeApplications.CruisesFacilityCabin;
    ...
    protected void btOK_Click(object sender, EventArgs e)
    {
        ...
        if(isid != "")
        {
            ...
            Subitems.UpdateSubitemsFull(iid, lang, app, tbCabin.Text, chiTiet, image, baoGom, "", tbHuongPhong.Text,
            ...
            ltrThongBao.Text = "Thông báo: đã sửa " + tbCabin.Text;
        }
        else
        {
            string image = flAnhDaiDien.Save(false, chiTiet);
            Subitems.InsertSubitemsFull(iid, lang, app, tbCabin.Text, chiTiet, image, baoGom, "", tbHuongPhong.Text,
            ...
            ltrThongBao.Text = "Thông báo: đã tạo " + tbCabin.Text;
        }        
    ...
    void ResetControls()
    {
        tbCabin.Text = tbGiaNiemYet.Text = tbGiaKhuyenMai.Text = tbLoaiGiuong.Text =tbHuongPhong.Text= tbChiTiet.Text="";
        hdChiTiet.Value = "";
