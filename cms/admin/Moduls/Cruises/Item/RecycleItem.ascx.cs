...
public partial class cms_admin_Moduls_Cruises_Item_RecycleItem : System.Web.UI.UserControl
{
    ...
    void GetParentCate()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ddl_group_ontab.Items.Add(new ListItem(Developer.CruisesKeyword.TatCaDanhMuc, ""));
