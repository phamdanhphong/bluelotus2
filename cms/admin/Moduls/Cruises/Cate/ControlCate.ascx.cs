...
using Link = TatThanhJsc.CruisesModul.Link;

public partial class cms_admin_Moduls_Cruises_Cate_ControlCate : System.Web.UI.UserControl
{
    ...
    {        
        return Link.LnkMnCruisesCateCreate();
    }
    ...
    public string DisplayCate(DataTable dt)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            s += "<div class=\"splitc\">|</div>";
            s += "<div class=\"cot7\">";
            s += "<a title='Click để xem và thêm mới " + CruisesKeyword.Cruises2 + " cho danh mục này' href=\"" + UrlExtension.WebisteUrl + "admin.aspx?uc=" + app + "&igid=" + dt.Rows[i]["IGID"] + "&suc=" + TypePage.Item + "\"><span class='iconItem plus'><!----></span></a>";
