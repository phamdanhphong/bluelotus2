<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutCate.ascx.cs" Inherits="cms_admin_Moduls_Cruises_Cate_ShortCutCate" %>
...
<div id="ShortCutCate" class="InsertPanel InitQuikMenu">
    ...
    <div class="controlBox">
        ...
        <div class="row">
            <div class="text"><%=Developer.CruisesKeyword.TenDanhMuc%></div>
            <div class="control">
