...
public partial class cms_admin_Moduls_Cruises_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.CruisesKeyword.CapNhatNhomCruises;
            btOK.Text = "Đồng ý";
        ...
        {
            LtInsertUpdate.Text = Developer.CruisesKeyword.TaoNhomMoi;
            btOK.Text = "Đồng ý";
        }
        #endregion
    }
