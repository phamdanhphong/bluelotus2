<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlsConfig.ascx.cs" Inherits="cms_admin_Cruises_Controls_AdmControlsConfiguration" %>
...
<div id="ControlsConfig">    
    ...
    <div class="smalltextbox">
        <div class="fl pl20">Số <%= CruisesKeyword.Cruises2 %> trên trang chủ:</div>
        <div class="fl pl10">
            <asp:TextBox ID="tbSoCruisesTrenTrangChu" runat="server"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server"
                                            ErrorMessage="Vui lòng số tự nhiên(vd: 6)" ControlToValidate="tbSoCruisesTrenTrangChu"
                                            Display="Dynamic" SetFocusOnError="True" ValidationExpression="\d*">
            </asp:RegularExpressionValidator>
        </div>
        <div class="cb h20"><!----></div>
        <div class="fl pl20">Số <%= CruisesKeyword.Cruises2 %> trên trang danh mục:</div>
        <div class="fl pl10">
            <asp:TextBox ID="tbSoCruisesTrenTrangDanhMuc" runat="server"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server"
                                            ErrorMessage="Vui lòng số tự nhiên(vd: 6)" ControlToValidate="tbSoCruisesTrenTrangDanhMuc"
                                            Display="Dynamic" SetFocusOnError="True" ValidationExpression="\d*">
            </asp:RegularExpressionValidator>
        </div>
        <div class="cb h20"><!----></div>
        <div class="fl pl20">Số <%= CruisesKeyword.Cruises2 %> khác trên một trang:</div>
        <div class="fl pl10">
            <asp:TextBox ID="tbSoCruisesKhacTrenMotTrang" runat="server"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server"
                                            ErrorMessage="Vui lòng số tự nhiên(vd: 6)" ControlToValidate="tbSoCruisesKhacTrenMotTrang"
                                            Display="Dynamic" SetFocusOnError="True" ValidationExpression="\d*">
            </asp:RegularExpressionValidator>
        </div>
    </div>
