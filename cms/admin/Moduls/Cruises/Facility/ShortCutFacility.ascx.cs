...
public partial class cms_admin_Moduls_Cruises_Facility_ShortCutFacility : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    protected string app = CodeApplications.CruisesFacility;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.Cruises, TypePage.Facility, ddlParentCate.SelectedValue);
    }
