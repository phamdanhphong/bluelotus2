...
public partial class cms_admin_Moduls_TrainTicket_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.TrainTicketKeyword.CapNhatNhomTrainTicket;
        ...
        {
            LtInsertUpdate.Text = Developer.TrainTicketKeyword.TaoNhomMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
