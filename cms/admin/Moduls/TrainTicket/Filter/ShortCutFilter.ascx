<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutFilter.ascx.cs" Inherits="cms_admin_Moduls_TrainTicket_Filter_ShortCutFilter" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/TrainTicket/Filter/ShortCutFilter/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admsccate">
    ...
    <div class="pdControl">
        ...
        <div class="text"><div class="pt5"><%=Developer.TrainTicketKeyword.LoaiThuocTinh %></div></div>
        ...
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.TrainTicketKeyword.TenThuocTinh%></div></div>
        <div class="control">
        ...
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.TrainTicketKeyword.ThuocTinhLocCon%>:</div></div>
        <div class="control">
            <asp:DropDownList ID="ddlSubFilterMode" runat="server">
                <asp:ListItem Value="0" Text="Chọn 1 thuộc tính/Vé tàu"></asp:ListItem>
                <asp:ListItem Value="1" Text="Chọn nhiều thuộc tính/Vé tàu"></asp:ListItem>
            </asp:DropDownList>
        </div>
        ...
        <div>
            ...
            <div class="control"><asp:TextBox ID="textTagDescription" runat="server" Width="580px" CssClass="tbDesc_Seo" Height="50px" TextMode="MultiLine"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
        </div>
