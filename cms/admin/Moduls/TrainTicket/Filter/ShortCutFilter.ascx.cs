...
public partial class cms_admin_Moduls_TrainTicket_Filter_ShortCutFilter : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.TrainTicketFilterProperties;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.TrainTicket, TypePage.Filter, DdlGroupTrainTicket.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.TrainTicketKeyword.CapNhatThuocTinh;
        ...
        {
            LtInsertUpdate.Text = Developer.TrainTicketKeyword.TaoThuocTinhLocMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
