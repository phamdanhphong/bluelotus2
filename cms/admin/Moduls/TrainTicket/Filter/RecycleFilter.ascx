<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleFilter.ascx.cs" Inherits="cms_admin_Moduls_TrainTicket_Filter_RecycleFilter" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/TrainTicket/Filter/RecycleFilter/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="TrainTicketRecycleFilter">
