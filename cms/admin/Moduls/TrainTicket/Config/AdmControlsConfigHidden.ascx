<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdmControlsConfigHidden.ascx.cs" Inherits="cms_admin_TrainTicket_Controls_AdmControlsConfigurationHidden" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/TrainTicket/Config/AdmControlsConfigHidden/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="AdmControlsConfigHidden">
    ...
    <div class="ffTahoma fs12">        
        ...
        <div class='fwb pb10 pt10'>
            Danh sách các trường thông tin Vé tàu:            
        </div>
        <div class='pb5'>
            ...
            <asp:Repeater ID="rptList" runat="server" onitemcommand="rptList_ItemCommand">
                <ItemTemplate>
                    <div class='pt5 pb5 bdbs'>
                        ...
                        <div class='fr'>
                            <div class='IconTool'>
                                <asp:LinkButton ToolTip="Click để xóa mục đang chọn" ID="lnk_delete" runat="server" CommandName="delete" CommandArgument='<%#Eval("igid").ToString() %>' OnClientClick="return confirm('Chú ý: xoá trường này sẽ xoá toàn bộ dữ liệu của Vé tàu về trường này.');"><span class='iconDelete'><!----></span></asp:LinkButton>
                            </div>
                            <div class='IconTool'>
