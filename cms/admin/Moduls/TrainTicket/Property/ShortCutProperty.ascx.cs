...
public partial class cms_admin_Moduls_TrainTicket_Property_ShortCutProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.TrainTicketProperty;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.TrainTicket, TypePage.Property, DdlGroupTrainTicket.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        {
            LtInsertUpdate.Text = Developer.TrainTicketKeyword.TaoThuocTinhMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
