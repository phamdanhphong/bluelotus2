<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleProperty.ascx.cs" Inherits="cms_admin_Moduls_TrainTicket_Property_RecycleProperty" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/TrainTicket/Property/RecycleProperty/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="TrainTicketRecycleProperty">
