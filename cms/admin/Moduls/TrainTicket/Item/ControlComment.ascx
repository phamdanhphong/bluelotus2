<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlComment.ascx.cs" Inherits="cms_admin_Moduls_TrainTicket_Item_ControlComment" %>
<%@ Import Namespace="TatThanhJsc.Extension" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server"><link href="~/cms/admin/Moduls/TrainTicket/Item/ControlComment/_cs.css" rel="stylesheet" type="text/css" /></cc1:StyleSheetCombiner>
...
<div id="ControlComment">
    ...
    <div class="BgTabTitle" align="center">
        ...
        <div class="split">|</div>                    
        <div class="cot3">
            <%=Developer.TrainTicketKeyword.TrichNoiDung %>
        </div>                        
        <div class="split">|</div>                    
        <div class="cot5">
                ...
                <div id="Item-<%#Eval("ISID").ToString()%>">
                    <div class="bgItem">
                        ...
                        <div class="fr tool pr5">                            
                            <a title="Click để xem chi tiết phản hồi này" href="javascript:void(0)" onclick="NewWindow_('cms/admin/Moduls/TrainTicket/Item/Popup/ViewComments.aspx?iid=<%#Eval("IID")%>&isid=<%#Eval("isid")%>#<%#Eval("isid")%>','ImageList','950','600','yes','yes')"><span class='iconPhanHoi'><!----></span></a>
