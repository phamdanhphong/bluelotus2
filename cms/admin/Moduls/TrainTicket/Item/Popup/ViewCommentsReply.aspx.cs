...
public partial class cms_admin_Moduls_TrainTicket_PopUp_Items_ViewCommentsReply : System.Web.UI.Page
{
    string top = "";
    string field = "";
    string condition = "";
    ...
    string app = CodeApplications.TrainTicketComment + "Reply";
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/TrainTicket/Item/Popup/ViewComments.aspx?iid=" + iid + "&isid=" + isid);
    }
}