...
public partial class cms_admin_Moduls_TrainTicket_Item_SubControl_SubControlComment : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle = "Phản hồi "+TrainTicketKeyword.TrainTicket2+" mới";
    private string app = CodeApplications.TrainTicketComment;
