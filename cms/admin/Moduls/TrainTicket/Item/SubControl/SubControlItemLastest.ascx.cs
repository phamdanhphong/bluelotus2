...
public partial class cms_admin_Moduls_TrainTicket_Item_SubControl_SubControlItemLastest : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle =TrainTicketKeyword.TrainTicket1 + " mới cập nhật";
