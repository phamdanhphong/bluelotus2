...
public partial class cms_admin_TrainTicket_ShowTrainTicketControl_ViewCart : System.Web.UI.Page
{
    private string iid = "";

    private string app =TatThanhJsc.TrainTicketModul.CodeApplications.TrainTicketCart; 
