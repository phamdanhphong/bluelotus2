<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleCate.ascx.cs" Inherits="cms_admin_Moduls_PhotoAlbum_Cate_RecycleCate" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/PhotoAlbum/Cate/RecycleCate/_cs.css" rel="stylesheet" type="text/css" />
