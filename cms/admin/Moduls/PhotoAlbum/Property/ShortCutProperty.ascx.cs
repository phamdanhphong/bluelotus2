...
public partial class cms_admin_Moduls_PhotoAlbum_Property_ShortCutProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.PhotoAlbumProperty;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.PhotoAlbum, TypePage.Property, DdlGroupPhotoAlbum.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.PhotoAlbumKeyword.CapNhatThuocTinh;
        ...
        {
            LtInsertUpdate.Text = Developer.PhotoAlbumKeyword.TaoThuocTinhMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
