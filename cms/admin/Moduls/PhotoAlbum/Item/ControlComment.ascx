<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlComment.ascx.cs" Inherits="cms_admin_Moduls_PhotoAlbum_Item_ControlComment" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server"><link href="~/cms/admin/Moduls/PhotoAlbum/Item/ControlComment/_cs.css" rel="stylesheet" type="text/css" /></cc1:StyleSheetCombiner>

<asp:HiddenField ID="hd_time" runat="server" />
<div id="ControlComment">
    <div class="BgTabTool">        
        <a href="javascript:DeleteListSubItems()" class="LinkDelete"><%=Developer.PhotoAlbumKeyword.Xoa%></a>                                   
    </div>
    ...
    <div class="BgTabTitle" align="center">
        ...
        <div class="cot2" align="left">        
            <%=Developer.PhotoAlbumKeyword.ThongTinNguoiGui %>
        </div>
        <div class="split">|</div>                    
        <div class="cot3">
            <%=Developer.PhotoAlbumKeyword.TrichNoiDung %>
        </div>                        
        <div class="split">|</div>                    
        <div class="cot5">
            <%=Developer.PhotoAlbumKeyword.TrangThai %>
        </div>                        
        <div class="split">|</div>                    
                ...
                <div id="Item-<%#Eval("ISID").ToString()%>">
                    <div class="bgItem">
                        ...
                        <div class="fr tool pr5">                            
                            <a title="Click để xem chi tiết phản hồi này" href="javascript:void(0)" onclick="NewWindow_('cms/admin/Moduls/PhotoAlbum/Item/Popup/ViewComments.aspx?iid=<%#Eval("IID")%>&isid=<%#Eval("isid")%>#<%#Eval("isid")%>','ImageList','950','600','yes','yes')"><span class='iconPhanHoi'><!----></span></a>
