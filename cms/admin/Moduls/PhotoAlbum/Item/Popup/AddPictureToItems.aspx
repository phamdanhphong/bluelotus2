...
<body>
    ...
    <div class="w900 ma ffTahoma fs12">        
        ...
        <div class='pb5'>
            ...
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/PhotoAlbum/Item/Popup/AddPictureToItems/swfupload/swfupload.js"></script>
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/PhotoAlbum/Item/Popup/AddPictureToItems/swfupload/handlers.js"></script>
            <script type="text/javascript">
                var swfu;
                window.onload = function () {
                    ...
                    swfu = new SWFUpload({
                        // Backend Settings            
                        upload_url: weburl + "cms/admin/Moduls/PhotoAlbum/Item/Popup/AddPictureToItems/upload.aspx?iid=" + iid+"&color="+color,
                        post_params: {
                        ...
                        // Button settings
                        button_image_url: weburl + "cms/admin/Moduls/PhotoAlbum/Item/Popup/AddPictureToItems/swfupload/btupload.png",
                        ...
                        // Flash Settings
                        flash_url: weburl + "cms/admin/Moduls/PhotoAlbum/Item/Popup/AddPictureToItems/swfupload/swfupload.swf", // Relative to this file
            ...
            <asp:Panel ID="pnMauHinhAnh1" runat="server">            
                <div>
                    <div>Chọn màu hình ảnh</div>
                    <div class='cb h5'><!----></div>
                    <div id="ListColor1">
                ...
                <ItemTemplate>
                    <div class='pt5 pb5 bdbs'>
                        ...
                        <div class='fl w200 pl5'>
                            <%#ImagesExtension.GetImage(FolderPic.PhotoAlbum, Eval(TatThanhJsc.Columns.SubitemsColumns.VsimageColumn).ToString(), "", "hotelImage", false, false, "")%>&nbsp;
                        </div>
                        ...
                        <div class='fl w200 pl5 bdls bdrs'>                            
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%#Eval(TatThanhJsc.Columns.SubitemsColumns.VscontentColumn).ToString()%>' ToolTip='<%#Eval("ISID").ToString()%>'  CssClass="TextInBox" TextMode="MultiLine" style="width:180px;height:60px;font-size:12px;resize:none" AutoPostBack="true" OnTextChanged="UpdateContent"></asp:TextBox>&nbsp;
                        </div> 
