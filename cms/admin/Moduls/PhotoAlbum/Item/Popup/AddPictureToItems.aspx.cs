...
public partial class cms_admin_ModulMain_Hotel_PopUp_Items_AddPictureToItems : System.Web.UI.Page
{
    ...
    string pathFolderPic = FolderPic.PhotoAlbum;
...
";
    ...
    protected void btCancel_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/PhotoAlbum/Item/PopUp/AddPictureToItems.aspx?iid=" + iid);
    }
    void GetList()
    {
    ...
    protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        switch (c)
        {
            ...
            case "edit":
                //OpenUpdatePanel(p);
                Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/PhotoAlbum/Item/PopUp/AddPictureToItems.aspx?iid=" + iid + "&isid=" + p);
                break;
            #endregion
        }
    }
    ...
    protected void UpdateContent(object sender, EventArgs e)
    {
        ...
        string[] fields = { SubitemsColumns.VscontentColumn };
        string[] values = { "N'" + textbox.Text + "'" };
        string condition = SubitemsTSql.GetSubitemsByIsid(textbox.ToolTip);
        Subitems.UpdateSubitems(DataExtension.UpdateTransfer(fields, values), condition);
        //GetListPhotoAlbums("");
