<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SubControlItemLastest.ascx.cs" Inherits="cms_admin_Moduls_PhotoAlbum_Item_SubControl_SubControlItemLastest" %>
<%@ Import Namespace="TatThanhJsc.AdminModul" %>
<%@ Import Namespace="TatThanhJsc.PhotoAlbumModul" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">    
    <link href="~/cms/admin/Moduls/PhotoAlbum/Item/SubControl/SubControlItemLastest/_cs.css" rel="stylesheet" type="text/css" />   
</cc1:StyleSheetCombiner>

<asp:UpdatePanel ID="UpdatePanel1" runat="server">
<ContentTemplate>
<div id="SubPhotoAlbumItemLastest">    
    <div class="header">
            ...
            <ItemTemplate>
                <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
                    ...
                    <div class="fr tool">      
                        ...
                        <a title="Cập nhật" href="<%#LinkAdmin.GoAdminItem(CodeApplications.PhotoAlbum, TypePage.UpdateItem, Eval("IID").ToString())%>"><span class="iconEdit"><!----></span></a>
