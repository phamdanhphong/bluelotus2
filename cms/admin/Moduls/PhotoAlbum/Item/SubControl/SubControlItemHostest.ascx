<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SubControlItemHostest.ascx.cs" Inherits="cms_admin_Moduls_PhotoAlbum_Item_SubControl_SubControlItemHostest" %>
<%@ Import Namespace="TatThanhJsc.AdminModul" %>
<%@ Import Namespace="TatThanhJsc.PhotoAlbumModul" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">    
    <link href="~/cms/admin/Moduls/PhotoAlbum/Item/SubControl/SubControlItemHostest/_cs.css" rel="stylesheet" type="text/css" />   
</cc1:StyleSheetCombiner>

<asp:UpdatePanel ID="UpdatePanel1" runat="server">
<ContentTemplate>
<div id="SubPhotoAlbumItemHostest">    
    <div class="header">
