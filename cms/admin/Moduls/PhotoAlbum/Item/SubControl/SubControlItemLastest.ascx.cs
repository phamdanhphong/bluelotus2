...
public partial class cms_admin_Moduls_PhotoAlbum_Item_SubControl_SubControlItemLastest : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle =PhotoAlbumKeyword.PhotoAlbum1 + " mới cập nhật";
