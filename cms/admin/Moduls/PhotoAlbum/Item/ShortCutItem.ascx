<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutItem.ascx.cs" Inherits="cms_admin_Moduls_PhotoAlbum_Item_ShortCutItem" %>
<%@ Import Namespace="Developer" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">    
    <link href="~/cms/admin/Moduls/PhotoAlbum/Item/ShortCutItem/_cs.css" rel="stylesheet" type="text/css" />
</cc1:StyleSheetCombiner>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<asp:HiddenField ID="hdOldPhotoAlbum" runat="server" Value=""/>
...
<div id="admscitem">
    ...
    <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.DanhMucCha%></div></div>
    <div class="control"><asp:DropDownList ID="ddl_group_product" runat="server" Width="222px"></asp:DropDownList> </div>
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.TieuDe%></div></div>
    <div class="control">
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.Ma%></div></div>
    <div class="control">
        <asp:TextBox ID="tbKey" runat="server" Width="400px"></asp:TextBox>        
    </div>

    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.MoTa%></div></div>
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.NgayDang%></div></div>
    <div>
    ...
    <div class="cbh8"><!----></div>    
    <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.ThuTu%></div></div>
    <div class="control">
    ...
    <div class="cbh8"><!----></div>
    <div style="float: left" class="text"><%=PhotoAlbumKeyword.AnhDaiDien%></div>
    ...
    <div class="dn">
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.MoTaHinhAnh%></div></div>
    ...
    <div><%=PhotoAlbumKeyword.ChiTiet%></div>
    <div class="cbh10"><!----></div>
    <div><CKEditor:CKEditorControl ID="txt_content" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&path=pic/PhotoAlbum"></CKEditor:CKEditorControl></div>        
    <div class="cbh10"><!----></div>       
                                
    <asp:Panel ID="pnThuocTinhHinhAnh" runat="server">
    <div class="cbh8"><!----></div>        
    <div><%=Developer.PhotoAlbumKeyword.ThuocTinhHinhAnh%></div>
    <div class="cbh8"><!----></div>
    <div class="ThuocTinhHinhAnh">
    ...
    <div class="KhungToiUu PdKhungToiUu">
        <div class="TextSeoLink"><%=PhotoAlbumKeyword.ToiUuTimKiem%> </div>
        <div>
            <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.ToiUuTheTieuDe%> </div></div>
            <div class="control1"><asp:TextBox ID="textTagTitle" runat="server" Width="400px" CssClass="tbTitle_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.ToiUuDuongDan%> </div></div>
            <div class="control1"><asp:TextBox ID="textLinkRewrite" runat="server" Width="400px" CssClass="tbLink_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.ToiUuTheMoTa%> </div></div>
            ...
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.ToiUuTheTuKhoa%> </div></div>
            <div class="control1"><asp:TextBox ID="textTagKeyword" runat="server" Width="400px" CssClass="tbKeyword_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="dn">
                <div class="text"><div class="pt5"><%=PhotoAlbumKeyword.Tag%> </div></div>
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><%=PhotoAlbumKeyword.TrangThai%></div>
