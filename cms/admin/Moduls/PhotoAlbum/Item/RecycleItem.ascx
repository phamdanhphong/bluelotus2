<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleItem.ascx.cs" Inherits="cms_admin_Moduls_PhotoAlbum_Item_RecycleItem" %>
...
<div id="admitem">
    <div class="BgTabTool">        
        <a href="javascript:DeleteRecListItems('<%=pic %>')" class="LinkDelete"><%=Developer.PhotoAlbumKeyword.Xoa%></a>                   
        <div class="right dn">            
            <div class="fl pr5">
