...
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server"><link href="~/cms/admin/Moduls/PhotoAlbum/Item/ControlItem/_cs.css" rel="stylesheet" type="text/css" /></cc1:StyleSheetCombiner>
...
<div id="admitem">
    ...
    <div class="BgTabTitle" align="center">
        ...
        <div class="split">|</div>                    
        <div class="fr pr5"><%=Developer.PhotoAlbumKeyword.CongCu %></div>                    
        <div class="cb"><!----></div>
    </div>
                ...
                <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
                    <div class="bgItem">
                        ...
                        <div class="fr tool pr5">
                            <a class="<%=PhotoAlbumConfig.KeyHienThiQuanLyPhanHoiHinhAnh %>" href="javascript:NewWindow_('cms/admin/Moduls/PhotoAlbum/Item/PopUp/ViewComments.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconPhanHoi'><!----></span></a>                            
                            <a title="<%=Developer.PhotoAlbumKeyword.ClickDeThemHinhAnh %>" href="javascript:NewWindow_('cms/admin/Moduls/PhotoAlbum/Item/PopUp/AddPictureToItems.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconThemAnh'><!----></span></a>
                            
                            <a class="<%=TagConfig.KeyHienThiTagChoPhotoAlbum%>" title="Click để thêm tag" href="javascript:NewWindow_('cms/admin/TempControls/PopUp/Items/AddTags.aspx?iid=<%#Eval("IID")%>&Modul=<%=app %>','ImageList','950','600','yes','yes')"><span class='iconThemTag'><!----></span></a>

                            <div class="dn">
                                <a title="<%=Developer.PhotoAlbumKeyword.ClickDeThemVaoNhom %>" href="javascript:NewWindow_('cms/admin/Moduls/PhotoAlbum/Item/Popup/AddItemToGroups.aspx?iid=<%#Eval("IID")%>','ImageList','800','450','yes','yes')"><span class='iconThemVaoNhom'><!----></span></a> 
                            </div>
...
<div id="SubItemSearch">
    <div class="frame">
        <div class="frame2">
            <div class="fl pr10">
                <asp:TextBox ID="tbTitleSearch" runat="server" placeholder="Tiêu đề album"></asp:TextBox>
            </div>
            <div class="fl pr10">
                <asp:TextBox ID="tbKeySearch" runat="server" placeholder="Mã album"></asp:TextBox>
            </div>
            <div class="fl">
