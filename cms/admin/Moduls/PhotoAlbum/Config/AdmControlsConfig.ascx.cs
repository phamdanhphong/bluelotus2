...
public partial class cms_admin_PhotoAlbum_Controls_AdmControlsConfiguration : System.Web.UI.UserControl
{
    ...
    {
        tbSoPhotoAlbumTrenTrangChu.Text = SettingsExtension.GetSettingKey(SettingKey.SoPhotoAlbumTrenTrangChu,language);
        tbSoPhotoAlbumKhacTrenMotTrang.Text = SettingsExtension.GetSettingKey(SettingKey.SoPhotoAlbumKhacTrenMotTrang, language);
        tbSoPhotoAlbumTrenTrangDanhMuc.Text = SettingsExtension.GetSettingKey(SettingKey.SoPhotoAlbumTrenTrangDanhMuc, language);      
        ...
        rbViTriDongDau.SelectedValue = SettingsExtension.GetSettingKey(SettingKey.DongDauAnhPhotoAlbum_ViTri, language);
        tbLeX.Text = SettingsExtension.GetSettingKey(SettingKey.DongDauAnhPhotoAlbum_LeNgang, language);
        tbLeY.Text = SettingsExtension.GetSettingKey(SettingKey.DongDauAnhPhotoAlbum_LeDoc, language);
        tbPhanTram.Text = SettingsExtension.GetSettingKey(SettingKey.DongDauAnhPhotoAlbum_TyLe, language);
        tbTrongSuot.Text = SettingsExtension.GetSettingKey(SettingKey.DongDauAnhPhotoAlbum_TrongSuot, language);
        #endregion
        ...
        LoadConfigs("cms/admin/Moduls/PhotoAlbum/Index.ascx");

    }

    protected void btSave_Click(object sender, EventArgs e)
    {
        SettingsExtension.SetOtherSettingKey(SettingKey.SoPhotoAlbumTrenTrangChu, tbSoPhotoAlbumTrenTrangChu.Text, language);
        SettingsExtension.SetOtherSettingKey(SettingKey.SoPhotoAlbumKhacTrenMotTrang, tbSoPhotoAlbumKhacTrenMotTrang.Text, language);
        SettingsExtension.SetOtherSettingKey(SettingKey.SoPhotoAlbumTrenTrangDanhMuc, tbSoPhotoAlbumTrenTrangDanhMuc.Text, language);       

        #region Đóng dấu ảnh
        if (cbDongDauAnh.Checked)
            SettingsExtension.SetOtherSettingKey(SettingKey.DongDauAnhPhotoAlbum, "1", language);
        else
            SettingsExtension.SetOtherSettingKey(SettingKey.DongDauAnhPhotoAlbum, "0", language);
        ...
        if (fulDongDauAnh.PostedFile.ContentLength > 0)
        {
            ...
            SettingsExtension.SetOtherSettingKey(SettingKey.DongDauAnhPhotoAlbum_AnhDau, fileName, language);
        }
        #endregion

        SettingsExtension.SetOtherSettingKey(SettingKey.DongDauAnhPhotoAlbum_ViTri, rbViTriDongDau.SelectedValue, language);
        SettingsExtension.SetOtherSettingKey(SettingKey.DongDauAnhPhotoAlbum_LeNgang, tbLeX.Text, language);
        SettingsExtension.SetOtherSettingKey(SettingKey.DongDauAnhPhotoAlbum_LeDoc, tbLeY.Text, language);
        SettingsExtension.SetOtherSettingKey(SettingKey.DongDauAnhPhotoAlbum_TyLe, tbPhanTram.Text, language);
        SettingsExtension.SetOtherSettingKey(SettingKey.DongDauAnhPhotoAlbum_TrongSuot, tbTrongSuot.Text, language);
        #endregion

        #region Hạn chế kích thước ảnh đại diện
        if (cbHanCheKichThuoc.Checked)
            SettingsExtension.SetOtherSettingKey(SettingKey.HanCheKichThuocAnhPhotoAlbum, "1", language);
        else
            SettingsExtension.SetOtherSettingKey(SettingKey.HanCheKichThuocAnhPhotoAlbum, "0", language);

        SettingsExtension.SetOtherSettingKey(SettingKey.HanCheKichThuocAnhPhotoAlbum_MaxWidth, tbHanCheW.Text, language);
        SettingsExtension.SetOtherSettingKey(SettingKey.HanCheKichThuocAnhPhotoAlbum_MaxHeight, tbHanCheH.Text, language);
        #endregion

        #region Tạo ảnh nhỏ cho ảnh đại diện
        if (cbTaoAnhNho.Checked)
            SettingsExtension.SetOtherSettingKey(SettingKey.TaoAnhNhoChoAnhPhotoAlbum, "1", language);
        else
            SettingsExtension.SetOtherSettingKey(SettingKey.TaoAnhNhoChoAnhPhotoAlbum, "0", language);

        SettingsExtension.SetOtherSettingKey(SettingKey.TaoAnhNhoChoAnhPhotoAlbum_MaxWidth, tbAnhNhoW.Text, language);
        SettingsExtension.SetOtherSettingKey(SettingKey.TaoAnhNhoChoAnhPhotoAlbum_MaxHeight, tbAnhNhoH.Text, language);
        #endregion
    ...
    /// </summary>
    /// <param name="vsdesc">Đường dẫn của control cha, vd: cms/admin/Moduls/PhotoAlbum/Index.ascx</param>
