...
public partial class cms_admin_Moduls_PhotoAlbum_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.PhotoAlbumKeyword.CapNhatNhomHinhAnh;
        ...
        {
            LtInsertUpdate.Text = Developer.PhotoAlbumKeyword.TaoNhomMoi;
            btn_insert_update.Text = "Đồng ý";
