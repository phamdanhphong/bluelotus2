...
public partial class cms_admin_Moduls_QA_Property_ShortCutProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.QAProperty;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.QA, TypePage.Property, DdlGroupQA.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.QAKeyword.CapNhatThuocTinh;
        ...
        {
            LtInsertUpdate.Text = Developer.QAKeyword.TaoThuocTinhMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
