<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutProperty.ascx.cs" Inherits="cms_admin_Moduls_QA_Property_ShortCutProperty" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
    <link href="~/cms/admin/Moduls/QA/Property/ShortCutProperty/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admsccate">
    ...
    <div class="pdControl">
        ...
        <div class="text"><div class="pt5"><%=Developer.QAKeyword.DanhMucCha %></div></div>
        <div class="control"><asp:DropDownList ID="DdlGroupQA" runat="server" Width="252px"></asp:DropDownList></div>
        <div class="cbh8"><!----></div>    
        <div class="text"><div class="pt5"><%=Developer.QAKeyword.TenThuocTinh%></div></div>
        <div class="control">
        ...
        <div class="cbh8"><!----></div>         
        <div class="text"><div class="pt5"><%=Developer.QAKeyword.MoTa%>:</div></div>
        <div class="control">
            <asp:TextBox ID="txtDesc" runat="server" Width="580px" Height="50px" TextMode="MultiLine" CssClass="tbDesc"></asp:TextBox>                            
        </div>
        <div class="cbh8"><!----></div>         

        <div class="text"><div class="pt5"><%=Developer.QAKeyword.Loai%></div></div>
        <div class="control">
        ...
        <div class="text"><%=Developer.QAKeyword.AnhDaiDien%>:</div>
        ...
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.QAKeyword.ThuTu %>:</div></div>
        <div class="control">
        ...
        <div class="cb h8"><!----></div>
        <div class="text"><div class="pt5"><%=Developer.QAKeyword.TrangThai %>:</div></div>
        <div class="control">
        ...
        <div class="cbh20"><!----></div>
        <div class="TextSeoLink"><%=Developer.QAKeyword.ToiUuTimKiem%> </div>
        <div>
            <div class="text"><div class="pt5"><%=Developer.QAKeyword.ToiUuDuongDan%>: </div></div>
            <div class="control"><asp:TextBox ID="textLinkRewrite" runat="server" Width="450px" CssClass="tbLink_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.QAKeyword.ToiUuTheTieuDe%>: </div></div>
            <div class="control"><asp:TextBox ID="textTagTitle" runat="server" Width="450px" CssClass="tbTitle_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.QAKeyword.ToiUuTheTuKhoa%>: </div></div>
            <div class="control"><asp:TextBox ID="textTagKeyword" runat="server" Width="450px" CssClass="tbKeyword_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=Developer.QAKeyword.ToiUuTheMoTa%>: </div></div>
