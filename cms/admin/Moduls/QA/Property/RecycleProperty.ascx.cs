...
public partial class cms_admin_Moduls_QA_Property_RecycleProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();

    private string Modul = CodeApplications.QAProperty;
    protected string pic = FolderPic.QA;
