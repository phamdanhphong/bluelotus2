...
public partial class cms_admin_Moduls_QA_Item_SubControl_SubControlItemLastest : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle =QAKeyword.QA1 + " mới cập nhật";
