<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SubControlComment.ascx.cs" Inherits="cms_admin_Moduls_QA_Item_SubControl_SubControlComment" %>
<%@ Import Namespace="TatThanhJsc.AdminModul" %>
<%@ Import Namespace="TatThanhJsc.QAModul" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">    
    <link href="~/cms/admin/Moduls/QA/Item/SubControl/SubControlComment/_cs.css" rel="stylesheet" type="text/css" />   
            ...
            <ItemTemplate>
                <div class="Item" id="Item-<%#Eval("ISID").ToString()%>">
                    ...
                    <div class="fr tool">
                        ...
                        <a title="Xem chi tiết phản hồi" href="javascript:void(0)" onclick="NewWindow_('cms/admin/Moduls/QA/Item/Popup/ViewComments.aspx?iid=<%#Eval("IID")%>&isid=<%#Eval("isid")%>#<%#Eval("isid")%>','ImageList','950','600','yes','yes')"><span class='iconPhanHoi'><!----></span></a>
