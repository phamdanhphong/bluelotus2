<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewComments.aspx.cs" Inherits="cms_admin_ModulMain_QA_PopUp_Items_ViewComments" ValidateRequest="false"%>
...
<head runat="server">
    <title>Phản hồi của hỏi đáp về hỏi đáp</title>        
                    ...
                    <div class='pt5 pb15 pl10 pr10 bdbs <%#currentCommentView(Eval("isid").ToString()) %>'>                        
                        <div class='pb5 bdbs'>
                            ...
                            <div class='fl pl10 pt3'>
                                <a class="lbtInsert" href="javascript:NewWindow_('<%=UrlExtension.WebisteUrl %>cms/admin/Moduls/QA/Item/Popup/ViewCommentsReply.aspx?iid=<%#Eval("IID")%>&isid=<%#Eval("isid")%>','ImageList','950','600','yes','yes')">Trả lời</a>
                            </div>                            
                            <a name="<%#Eval("isid") %>">&nbsp;</a>
                            <div class='cb'><!----></div>
                        </div>
