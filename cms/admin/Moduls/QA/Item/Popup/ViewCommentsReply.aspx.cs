...
public partial class cms_admin_Moduls_QA_PopUp_Items_ViewCommentsReply : System.Web.UI.Page
{
    string top = "";
    string field = "";
    string condition = "";
    ...
    string app = CodeApplications.QAComment + "Reply";
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/QA/Item/Popup/ViewComments.aspx?iid=" + iid + "&isid=" + isid);
    }
}