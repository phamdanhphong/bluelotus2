...
public partial class cms_admin_Moduls_QA_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.QAKeyword.CapNhatNhomQA;
        ...
        {
            LtInsertUpdate.Text = Developer.QAKeyword.TaoNhomMoi;
            btn_insert_update.Text = "Đồng ý";
