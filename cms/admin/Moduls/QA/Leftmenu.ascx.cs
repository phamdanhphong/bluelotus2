...
public partial class cms_admin_QA_AdmLeftmenu : System.Web.UI.UserControl
{    
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        PhManagerApi.Controls.Add(LoadControl("../../../api/QA/Leftmenu.ascx"));
    ...
    {
        //Ẩn hiện menu Quản lý thuộc tính hỏi đáp
        if (QAConfig.KeyHienThiQuanLyThuocTinhQA)
        {
            pnThuocTinhQA.Visible = true;
            pnThuocTinhQA_ThemMoi.Visible = true;
            pnThuocTinhQA_ThungRac.Visible = true;
        }
        else
        {
            pnThuocTinhQA.Visible = false;
            pnThuocTinhQA_ThemMoi.Visible = false;
            pnThuocTinhQA_ThungRac.Visible = false;
        }               
        //Ẩn hiện menu Quản lý phản hồi
        if (QAConfig.KeyHienThiQuanLyPhanHoiQA) pnDanhSachPhanHoi.Visible = true;
        else pnDanhSachPhanHoi.Visible = false;

        //Ẩn hiện menu Thống kê báo cáo
        if (QAConfig.KeyHienThiThongKeBaoCaoQA) pnThongKeBaoCao.Visible = true;
