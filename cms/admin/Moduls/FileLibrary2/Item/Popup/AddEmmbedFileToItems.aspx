<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddEmmbedFileToItems.aspx.cs" Inherits="cms_admin_ModulMain_FileLibrary2_PopUp_Items_AddEmmbedFileToItems" ValidateRequest="false"%>
...
<head runat="server">
    <title>Thêm tệp đính kèm cho tệp đính kèm</title>        
    ...
    <link href="AddEmmbedFileToItems/_cs.css" rel="stylesheet" type="text/css" />
    <link href="../../../../cs/Common.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
    <div id="AddEmmbedFileToItems">    
    ...
    <div class="w900 ma ffTahoma fs12">        
        ...
        <div class='pb5'>
            ...
            <asp:LinkButton ID="btInsert" runat="server" ToolTip="Click để thêm mới tệp đính kèm" CssClass="lbtInsert" onclick="btInsert_Click">Thêm từng tệp đính kèm một</asp:LinkButton>&nbsp;|&nbsp;
            <a class="lbtInsert" href="javascript:Toggle('Toogle_FlashUpload')">Thêm nhiều tệp đính kèm cùng lúc</a>
            <div class="cb h10"><!----></div>
            <div id="Toogle_FlashUpload" style="display:none">
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/FileLibrary2/Item/Popup/AddEmmbedFileToItems/swfupload/swfupload.js"></script>
            <script type="text/javascript" src="<%=UrlExtension.WebisteUrl%>cms/admin/Moduls/FileLibrary2/Item/Popup/AddEmmbedFileToItems/swfupload/handlers.js"></script>
            <script type="text/javascript">
                var swfu;
                window.onload = function () {
                    ...
                    swfu = new SWFUpload({
                        // Backend Settings            
                        upload_url: weburl + "cms/admin/Moduls/FileLibrary2/Item/Popup/AddEmmbedFileToItems/upload.aspx?iid=" + iid,
                        post_params: {
                            "ASPSESSID": "<%=Session.SessionID %>"
                        },
                        // File Upload Settings
                        file_size_limit: "5 MB",
                        file_types: "*.pdf; *.doc; *.docx; *.xls; *.xlsx; *.ppt; *.pptx; *.rar; *.zip",
                        file_types_description: "Tệp tin tệp đính kèm",
                        ...
                        // Button settings
                        button_image_url: weburl + "cms/admin/Moduls/FileLibrary2/Item/Popup/AddEmmbedFileToItems/swfupload/btupload.png",
                        ...
                        // Flash Settings
                        flash_url: weburl + "cms/admin/Moduls/FileLibrary2/Item/Popup/AddEmmbedFileToItems/swfupload/swfupload.swf", // Relative to this file
            ...
            <div id="khungUploadTuMayTinh" class="khungupload">
                <div class="tengroupbox">Upload tệp đính kèm từ máy tính của bạn</div>
            ...
            <asp:LinkButton ID="lnk_delete_user_checked" runat="server" CssClass="LinkCreateItem" onclick="lnk_delete_user_checked_Click" OnClientClick="return confirm('Bạn có chắc chắn muốn xóa các mục vừa chọn?');">Xóa các mục đang chọn</asp:LinkButton>
        <div class="bcccc pt5 pb5 bdas fwb">
            <div class='fl w20 tac bdrs'>
                <asp:CheckBox ID="chk_list" runat="server" AutoPostBack="true" oncheckedchanged="chk_list_CheckedChanged" />
            </div>
            <div class='fl w350 pl5 bdrs'>
                Tệp đính kèm
            </div>
            ...
            <asp:Repeater ID="rptList" runat="server" onitemcommand="rptList_ItemCommand">
                <ItemTemplate>
                    <div class='pt5 pb5 bdbs'>
                        <div class='fl w20 tac'>
                            <asp:CheckBox ID="chk_item" runat="server" ToolTip='<%#Eval("isid") %>'/>
                        </div>
                        <div class='fl w350 pl5'>
                            <%#LayThongTinTep(Eval(TatThanhJsc.Columns.SubitemsColumns.VscontentColumn).ToString()) %>
                        </div>
        ...
        <div>
            ...
            <div class='fl'>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ErrorMessage="Vui lòng điền tên tệp đính kèm." ControlToValidate="tbName" 
                    Display="Dynamic" SetFocusOnError="True"></asp:RequiredFieldValidator> 
            </div>
            <div class='cb h5'><!----></div>
        </div>     
        <div class="dn">            
            <div class="fl w120">Tệp đính kèm:</div>
            <div class="cotanh">
                <%--Đóng dấu ảnh--%>
        ...
        <div class="fl w120"><%=FileLibrary2Keyword.TepDinhKem%></div>
        <div style="float: left;width: 600px">
            <div class="khungThuocTinh">
                <div>
                    Chọn tệp đính kèm<br/>  
                    <div><asp:Literal ID="ltrFiles" runat="server" Visible="true"></asp:Literal></div>                    
