<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddItemToGroups.aspx.cs" Inherits="cms_admin_FileLibrary2_SubControls_AddItemToGroups" %>
        ...
        <ContentTemplate>
            <div id="PopupAddItem">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr valign="top">
                        <td style="width:45%">
                            <div class="TitleListBox">Các nhóm dữ liệu đã trực thuộc</div>
                        ...
                        <td style="width:45%">
                            <div class="TitleListBox">Các nhóm dữ liệu chưa trực thuộc</div>
