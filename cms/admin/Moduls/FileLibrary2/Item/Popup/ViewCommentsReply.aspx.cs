...
public partial class cms_admin_Moduls_FileLibrary2_PopUp_Items_ViewCommentsReply : System.Web.UI.Page
{
    string top = "";
    string field = "";
    string condition = "";
    ...
    string app = CodeApplications.FileLibrary2Comment + "Reply";
    ...
    {
        Response.Redirect(UrlExtension.WebisteUrl + "cms/admin/Moduls/FileLibrary2/Item/Popup/ViewComments.aspx?iid=" + iid + "&isid=" + isid);
    }
}