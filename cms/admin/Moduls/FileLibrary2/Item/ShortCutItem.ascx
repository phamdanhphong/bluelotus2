<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShortCutItem.ascx.cs" Inherits="cms_admin_Moduls_FileLibrary2_Item_ShortCutItem" %>
<%@ Import Namespace="Developer" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">    
    <link href="~/cms/admin/Moduls/FileLibrary2/Item/ShortCutItem/_cs.css" rel="stylesheet" type="text/css" />
</cc1:StyleSheetCombiner>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<asp:HiddenField ID="hdOldFileLibrary2" runat="server" Value=""/>
...
<div id="admscitem">
    ...
    <div class="text"><div class="pt5"><%=FileLibrary2Keyword.DanhMucCha%></div></div>
    <div class="control"><asp:DropDownList ID="ddl_group_product" runat="server" Width="222px"></asp:DropDownList> </div>
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=FileLibrary2Keyword.TieuDe%></div></div>
    <div class="control">
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=FileLibrary2Keyword.Ma%></div></div>
    <div class="control">
        <asp:TextBox ID="tbKey" runat="server" Width="400px"></asp:TextBox>        
    </div>

    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=FileLibrary2Keyword.MoTa%></div></div>
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><div class="pt5"><%=FileLibrary2Keyword.NgayDang%></div></div>
    <div>
    ...
    <div class="text"><div class="pt5"><%=FileLibrary2Keyword.ThuTu%></div></div>
    <div class="control">
    ...
    <asp:Panel ID="pnTepDinhKem" runat="server">
    <div class="text"><div class="pt5"><%=FileLibrary2Keyword.TepDinhKem%></div></div>
    <div style="float: left;width: 600px">
        <div class="khungThuocTinh">
            <div>
                Chọn tệp đính kèm<br/>  
                <div><asp:Literal ID="ltrFiles" runat="server" Visible="true"></asp:Literal></div>
                <div><asp:LinkButton ID="lnk_delete_File_current" runat="server" Visible="false" onclick="lnk_delete_File_current_Click">Xóa tệp hiện tại</asp:LinkButton></div>                  
    ...
    <div class="cbh8"><!----></div>
    <div style="float: left" class="text"><%=FileLibrary2Keyword.AnhDaiDien%></div>
    <div style="float: left;width: 600px">
    ...
    <div class="dn">
        <div class="cbh8"><!----></div>
        <div class="text"><div class="pt5"><%=FileLibrary2Keyword.MoTaHinhAnh%></div></div>
    ...
    <div><%=FileLibrary2Keyword.ChiTiet%></div>
    <div class="cbh10"><!----></div>
    <div><CKEditor:CKEditorControl ID="txt_content" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&path=pic/FileLibrary2"></CKEditor:CKEditorControl></div>        
    <div class="cbh10"><!----></div>       
                                
    <asp:Panel ID="pnThuocTinhDuLieu2" runat="server">
    <div class="cbh8"><!----></div>        
    <div><%=Developer.FileLibrary2Keyword.ThuocTinhDuLieu2%></div>
    <div class="cbh8"><!----></div>
    <div class="ThuocTinhDuLieu2">
    ...
    <div class="KhungToiUu PdKhungToiUu">
        <div class="TextSeoLink"><%=FileLibrary2Keyword.ToiUuTimKiem%> </div>
        <div>
            <div class="text"><div class="pt5"><%=FileLibrary2Keyword.ToiUuTheTieuDe%> </div></div>
            <div class="control1"><asp:TextBox ID="textTagTitle" runat="server" Width="400px" CssClass="tbTitle_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=FileLibrary2Keyword.ToiUuDuongDan%> </div></div>
            <div class="control1"><asp:TextBox ID="textLinkRewrite" runat="server" Width="400px" CssClass="tbLink_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=FileLibrary2Keyword.ToiUuTheMoTa%> </div></div>
            ...
            <div class="cbh8"><!----></div>
            <div class="text"><div class="pt5"><%=FileLibrary2Keyword.ToiUuTheTuKhoa%> </div></div>
            <div class="control1"><asp:TextBox ID="textTagKeyword" runat="server" Width="400px" CssClass="tbKeyword_seo"></asp:TextBox></div>
            <div class="cbh8"><!----></div>
            <div class="dn">
                <div class="text"><div class="pt5"><%=FileLibrary2Keyword.Tag%> </div></div>
    ...
    <div class="cbh8"><!----></div>
    <div class="text"><%=FileLibrary2Keyword.TrangThai%></div>
