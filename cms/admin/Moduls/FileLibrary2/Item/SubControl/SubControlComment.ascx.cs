...
public partial class cms_admin_Moduls_FileLibrary2_Item_SubControl_SubControlComment : System.Web.UI.UserControl
{    
    private string top = "";
    ...
    protected string subControlsTitle = "Phản hồi "+FileLibrary2Keyword.FileLibrary22+" mới";
    private string app = CodeApplications.FileLibrary2Comment;
