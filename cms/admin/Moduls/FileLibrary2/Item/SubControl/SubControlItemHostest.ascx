<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SubControlItemHostest.ascx.cs" Inherits="cms_admin_Moduls_FileLibrary2_Item_SubControl_SubControlItemHostest" %>
<%@ Import Namespace="TatThanhJsc.AdminModul" %>
<%@ Import Namespace="TatThanhJsc.FileLibrary2Modul" %>
<%@ Register TagPrefix="cc1" Namespace="CssJscriptOptimizer.Controls" Assembly="CssJscriptOptimizer" %>
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">    
    <link href="~/cms/admin/Moduls/FileLibrary2/Item/SubControl/SubControlItemHostest/_cs.css" rel="stylesheet" type="text/css" />   
</cc1:StyleSheetCombiner>

<asp:UpdatePanel ID="UpdatePanel1" runat="server">
<ContentTemplate>
<div id="SubFileLibrary2ItemHostest">    
    <div class="header">
            ...
            <ItemTemplate>
                <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
                    ...
                    <div class="fr tool">      
                        ...
                        <a title="Cập nhật" href="<%#LinkAdmin.GoAdminItem(CodeApplications.FileLibrary2, TypePage.UpdateItem, Eval("IID").ToString())%>"><span class="iconEdit"><!----></span></a>
