...
public partial class cms_admin_Moduls_FileLibrary2_Item_RecycleItem : System.Web.UI.UserControl
{
    ...
    void GetFileLibrary2(string order)
    {
        ...
        LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
                                                      ...
                                                      LinkAdmin.UrlAdmin(CodeApplications.FileLibrary2, TypePage.RecycleItem,
    ...
    void GetGroupsInDdl()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ddl_group_ontab.Items.Add(new ListItem(Developer.FileLibrary2Keyword.TatCaDanhMuc, ""));
