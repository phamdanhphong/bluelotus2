...
public partial class cms_admin_FileLibrary2_Loadcontrol : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (suc)
        {
            #region Api
            case "api":
                phControl.Controls.Add(LoadControl("../../../api/FileLibrary2/LoadControls.ascx"));
                break;
            #endregion
            #region Cate
            case TypePage.Cate:
