...
public partial class cms_admin_Moduls_FileLibrary2_Property_ShortCutProperty : System.Web.UI.UserControl
{
    private string language = TatThanhJsc.LanguageModul.Cookie.GetLanguageValueAdmin();
    private string app = CodeApplications.FileLibrary2Property;
    ...
    {
        return LinkAdmin.GoAdminSubModul(CodeApplications.FileLibrary2, TypePage.Property, DdlGroupFileLibrary2.SelectedValue);
    }
    ...
    void InitialControlsValue(bool insert)
    {
        ...
        if (!insert)
        {
            LtInsertUpdate.Text = Developer.FileLibrary2Keyword.CapNhatThuocTinh;
        ...
        {
            LtInsertUpdate.Text = Developer.FileLibrary2Keyword.TaoThuocTinhMoi;
            btn_insert_update.Text = "Đồng ý";
        }
        #endregion
    }
