...
public partial class cms_admin_Ajax_Groups_DeleteGroup : System.Web.UI.Page
{
    ...
    void DeleteCate()
    {
        ...
        Logs.InsertLogs(logCreateDate, Request.Url.ToString(), "", title, logAuthor, "", logCreateDate + ": " + logAuthor + " xóa " + title + " (id: " + igid + ")");
        #endregion
    }
