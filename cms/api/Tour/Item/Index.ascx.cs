...
public partial class cms_api_Tour_Item_Index : System.Web.UI.UserControl
{
    ...
    private static string CodeApp = CodeApplications.Tour;
    ...
    void GetIidNew()
    {
        string condition = DataExtension.AndConditon(GroupsTSql.GetGroupsByVglang(lang),
                                                    GroupsTSql.GetGroupsByVgapp(CodeApplications.Tour));
