...
public partial class cms_api_Hotel_Item_Index : System.Web.UI.UserControl
{
    ...
    private static string CodeApp = CodeApplications.Hotel;
    ...
    protected void btnTest_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(LinkAdmin.GoAdminCategory(CodeApplications.Hotel, TypePage.Item, igid));
    }

    void GetIidNew()
    {
        string condition = DataExtension.AndConditon(GroupsTSql.GetGroupsByVglang(lang),
                                                    GroupsTSql.GetGroupsByVgapp(CodeApplications.Hotel));
