<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="cms_api_Product_Cate_Index" %>
...
<div class="cbh10"><!----></div>
<div style="position: absolute;bottom: 21px;left:494px"><asp:Button ID="btOK" Width="120px" runat="server" Text="Đồng ý" OnClick="btOK_Click" /></div>