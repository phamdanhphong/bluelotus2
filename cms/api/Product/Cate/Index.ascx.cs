...
/// <summary>
/// Hướng dẫn sử dụng:
/// Dùng để thêm các trường khác vào danh mục sản phẩm, vd: video youtube cho danh mục, ảnh thứ hai cho một danh mục
/// Giải pháp: thêm một bản ghi vào item cho sản phẩm đó. Các thông số trên sẽ được lưu vào các trường trong items tùy theo cách bố trí của người lập trình. VD: viTitle - mã video...
/// Khi hiển thị: tìm bản ghi trong items theo igid và subapp. Hiển thị ra các thông tin theo cách bố trí khi lưu vào.
/// </summary>
public partial class cms_api_Product_Cate_Index : System.Web.UI.UserControl
{
