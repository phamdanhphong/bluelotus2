...
/// <summary>
/// Hướng dẫn sử dụng:
/// Dùng để thêm các trường khác vào chi tiết tin tức, vd: trạng thái hàng, số sao, xuất sứ...
/// Giải pháp: thêm một bản ghi vào subitems cho tin tức đó. Các thông số trên sẽ được lưu vào các trường trong subitems tùy theo cách bố trí của người lập trình. VD: vsTitle - trạng thái hàng, vsUrl - xuất sứ...
/// Khi hiển thị: tìm bản ghi trong subitems theo iid và subapp. Hiển thị ra các thông tin theo cách bố trí khi lưu vào.
/// </summary>
public partial class cms_api_New_Item_Index : System.Web.UI.UserControl
{
    ...
    {     
        //Hiện lên khi cần dùng
        //Subitems.InsertSubitems(iid, lang, subApp, tbTinhTrangHang.Text, ddlXepHangSao.SelectedValue, "", "", "", "", DateTime.Now.ToString(), "", "", "1");
    }
